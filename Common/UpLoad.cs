            ...
            if (PostedFile != null)
            {
                ...
                try
                {
                    ...
                    if (isAdmin != 1)
                    {
                        ...
                        //{
                        Extension = "jpg,gif,bmp,png,swf";//dt.Rows[0]["upfileType"].ToString();
                        getFileLent = 5000; //int.Parse(dt.Rows[0]["upfileSize"].ToString()) * 1024;
                        //}
                    }
                    ...
                    else
                    {
                        for (int i = 0; i < Exten.Length; i++)
                        {
                            if (fileName.ToLower().EndsWith(Exten[i].ToLower()))
                            {
                                ...
                                if (_num == 1)
                                {
                                    string _Randstr = Pbzx.Common.Method.Number(6);
