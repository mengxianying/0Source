...
namespace jdPay.signature
{
    public class SignUtil
    {
        public static String signRemoveSelectedKeys(SortedDictionary<String, String> dic, String rsaPriKey, List<String> signKeyList)
        {
            ...
            //Pbzx.Common.ErrorLog.WriteLogMeng("在线交易", "jd-SignUtil签名原串：" + sourceSignString, true, true);
            //摘要
           ...
           // Pbzx.Common.ErrorLog.WriteLogMeng("在线交易", "jd-sha256摘要:" + sourceSignString, true, true);
