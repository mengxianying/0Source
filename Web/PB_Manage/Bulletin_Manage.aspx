<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bulletin_Manage.aspx.cs"
    Inherits="Pbzx.Web.PB_Manage.Bulletin_Manage" %>
            ...
            <tr>
                <td bgcolor="#F3F3F3">
                                ...
                                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                                    <tr>
                                        <td width="91%" align="left">
                                            当前位置：
                                            <asp:Label ID="labAction" runat="server" />公告管理
                                        </td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                        <tr>
                            <td align="CENTER">
                                <a href="Bulletin_Manage.aspx">公告管理</a> |&nbsp;
                                <asp:LinkButton ID="btn_add" runat="server" OnClick="btn_add_Click">添加公告
                                </asp:LinkButton>&nbsp;|&nbsp;<asp:LinkButton ID="lblCreateIndex" runat="server"
                                    Text="更新首页和网站公告" OnClick="lblCreateIndex_Click"></asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#E7A427"
            ...
            <tr>
                <td bgcolor="#F7FBFF" align="left">
                    <uc1:UcBulletinSearch ID="UcBulletinSearch2" runat="server"></uc1:UcBulletinSearch>
                </td>
            </tr>
        </table>
                    ...
                    <asp:GridView ID="MyGridView" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="固顶">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnBitIsTop" runat="server" CommandArgument='<%# Eval("IntId") %>'
                                        OnCommand="lbtnBitIsTop_Command"><%# Convert.ToBoolean(Eval("BitIsTop")) ? "<font color=red>固顶</font>" : "不固"%></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle Width="4%" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="编辑">
                                <ItemTemplate>
                                    <a href='Bulletin_Editor.aspx?ID=<%#Eval("IntID") %>'>编辑</a>
                                </ItemTemplate>
                                <ItemStyle Width="4%" />
                            </asp:TemplateField>
