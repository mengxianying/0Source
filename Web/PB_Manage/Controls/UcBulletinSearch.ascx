<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcBulletinSearch.ascx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.UcBulletinSearch" %>
<table width="90%" align="left" cellpadding="1" cellspacing="0" border="0">
    <tr>
        <td>
            &nbsp;公告标题:</td>
        <td>
       ...
       <td>
           <asp:DropDownList ID="ddlChannel" runat="server" Width="90px">
           </asp:DropDownList>
       </td>
        <td>
            所属类别:</td>
        <td>
            <asp:DropDownList ID="ddlIntShowType" runat="server" Width="90px">
            </asp:DropDownList></td>
        <td>
            发布时间:</td>
        <td>
            <asp:DropDownList ID="ddlTime" runat="server" Width="90px">
