<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcSchoolSearch.ascx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.UcSchoolSearch" %>
    ...
    <tr>
       ...
       <td>
        ...
        <td>
            所属类别:</td>
        <td>
            <asp:DropDownList ID="ddlIntShowType" runat="server"  Width="95px">
            </asp:DropDownList></td>
        <td>
            发布时间:</td>
        <td>
