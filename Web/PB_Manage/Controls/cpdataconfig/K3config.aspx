<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="K3config.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.K3config" %>
            ...
            <div style="width: 100%;">
                                ...
                                <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                                            开奖号码:</td>
                                        <td>
                                            <asp:TextBox ID="txtcode" runat="server" Height="20px" MaxLength="3" Width="149px"
                                                onkeyup='onkeyup="this.value=this.value.toLocaleUpperCase()"'></asp:TextBox>（格式：123）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
                ...
                <div id="divBatchAdd" runat="server" visible="false">
                    <table style="width: 100%">
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                                批量数据录入（<font color="#ff0000">一期数据为一行，前面期号后面奖号。如：0711001 123）</font></td>
                        </tr>
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
