<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TCPKconfig.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.TCPKconfig" %>
            ...
            <div style="width: 100%;">
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtcode" runat="server" Height="20px" MaxLength="4" Width="149px"
                                                onkeyup='this.value=this.value.toLocaleUpperCase()'></asp:TextBox>（<span style="color: #ff0000">注意：数据中的10要输入T，如格式：K95T</span>）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
                ...
                <div id="divBatchAdd" runat="server" visible="false">
                    <table style="width: 100%">
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                                批量数据录入（<font color="#ff0000">一期数据为一行，前面期号后面奖号。如：9005714 A2T3）</font></td>
                        </tr>
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
