<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OtherX5configGuangD.aspx.cs"
    Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.OtherX5configGuangD" %>
    ...
    <form id="form1" runat="server">
        <div style="width: 100%;">
            ...
            <div style="width: 100%;">
                            ...
                            <td bgcolor="#F3F3F3">
                                ...
                                <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                    ...
                                    <%--<tr bgcolor="#F2F8FB">
                                        ...
                                        <td width="75%">
                                            <asp:TextBox ID="addNumber" MaxLength="4" runat="server"></asp:TextBox>
                                            （格式：1036）</td>
                                    </tr>--%>
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDate" runat="server" MaxLength="10"></asp:TextBox>（格式：2004-10-08）
                                        </td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                ...
                <br />
                <asp:RangeValidator ID="rvd1" runat="server" ControlToValidate="txtCode1" MaximumValue="26"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-26)" Display="None"></asp:RangeValidator>
                ...
                <asp:RangeValidator ID="rvd2" runat="server" ControlToValidate="txtCode2" MaximumValue="26"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-26)" Display="None"></asp:RangeValidator>
                ...
                <asp:RangeValidator ID="rvd3" runat="server" ControlToValidate="txtCode3" MaximumValue="26"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-26)" Display="None"></asp:RangeValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="rvd3">
                </cc1:ValidatorCalloutExtender>
                <asp:RangeValidator ID="rvd4" runat="server" ControlToValidate="txtCode4" MaximumValue="26"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-26)" Display="None"></asp:RangeValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" TargetControlID="rvd4">
                </cc1:ValidatorCalloutExtender>
                <asp:RangeValidator ID="rvd5" runat="server" ControlToValidate="txtCode5" MaximumValue="26"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-26)" Display="None"></asp:RangeValidator>
