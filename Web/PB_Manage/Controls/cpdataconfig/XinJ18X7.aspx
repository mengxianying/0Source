<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XinJ18X7.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.XinJ18X7" %>
            ...
            <div style="width: 100%;">
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td class="forumRow">
                                            ...
                                            <asp:TextBox ID="txtCode6" runat="server" Height="20px" MaxLength="2" Width="26px"
                                                onkeyup='CheckCode(this,"txtCode7")' onfocus="javascript:this.select()" ></asp:TextBox>&nbsp;
                                            <asp:TextBox ID="txtCode7" runat="server" Height="20px" MaxLength="2" Width="26px"
              ...
              <asp:HiddenField ID="HiddenField1" runat="server" Value="0" />
                <asp:RangeValidator ID="rvd1" runat="server" ControlToValidate="txtCode1" MaximumValue="50"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-50)" Display="None"></asp:RangeValidator>
                ...
                <asp:RangeValidator ID="rvd7" runat="server" ControlToValidate="txtCode7" MaximumValue="50"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-50)" Display="None"></asp:RangeValidator>
