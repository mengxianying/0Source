<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TC481config.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.TC481config" %>
              ...
              <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#7694D2"
                                ...
                                <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                                            开奖号码:</td>
                                        <td>
                                            <asp:TextBox ID="txtcode" runat="server" Height="20px" MaxLength="4" Width="149px"
                                              ></asp:TextBox>（注意：数据中不能带０和９，如格式：1658）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
                ...
                <div id="divBatchAdd" runat="server" visible="false">
                    <table style="width: 100%">
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                                批量数据录入（<font color="#ff0000">一期数据为一行，前面期号后面奖号。如：9000126 1658）</font></td>
                        </tr>
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
