<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherX7configGuangD.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.OtherX7configGuangD" %>
            ...
            <div style="width: 100%;">
                        ...
                        <tr>
                            <td bgcolor="#F3F3F3">
                                ...
                                <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                  ...
                                  <%--  <tr bgcolor="#F2F8FB" id="rowZong" runat="server">
                                        <td class="bold" width="25%">
                                            总期号:
                                        </td>
                                        <td width="75%">
                                            <asp:TextBox ID="txtAddNumber" MaxLength="7" runat="server"></asp:TextBox>
                                            （格式：1036）</td>
                                    </tr>--%>
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                                    ...
                                    <tr bgcolor="#F2F8FB" id="rowBluecode" runat="server">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtBluecode" runat="server" Height="20px" MaxLength="2" Width="26px"
                                                onkeyup='CheckCode(this,"btnSave")' onfocus="javascript:this.select()" ></asp:TextBox>
                                            <asp:Label ID="lblTCode" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
               ...
               <asp:HiddenField ID="HiddenField1" runat="server" Value="0" />
                <asp:RangeValidator ID="rvd1" runat="server" ControlToValidate="txtCode1" MaximumValue="30"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-36)" Display="None"></asp:RangeValidator>
                ...
                <asp:RangeValidator ID="rvd2" runat="server" ControlToValidate="txtCode2" MaximumValue="36"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-36)" Display="None"></asp:RangeValidator>
                ...
                <asp:RangeValidator ID="rvd3" runat="server" ControlToValidate="txtCode3" MaximumValue="36"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-36)" Display="None"></asp:RangeValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="rvd3">
                </cc1:ValidatorCalloutExtender>
                <asp:RangeValidator ID="rvd4" runat="server" ControlToValidate="txtCode4" MaximumValue="36"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-36)" Display="None"></asp:RangeValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" TargetControlID="rvd4">
                </cc1:ValidatorCalloutExtender>
                <asp:RangeValidator ID="rvd5" runat="server" ControlToValidate="txtCode5" MaximumValue="36"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-36)" Display="None"></asp:RangeValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" runat="server" TargetControlID="rvd5">
                </cc1:ValidatorCalloutExtender>
                <asp:RangeValidator ID="rvd6" runat="server" ControlToValidate="txtCode6" MaximumValue="36"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-36)" Display="None"></asp:RangeValidator>
