<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FC20X8Data.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.FC20X8Data" %>
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td class="forumRow">
                                            ...
                                            <asp:TextBox ID="txtCode6" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode7")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode7" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode8")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode8" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"btnSave")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            （格式：01 02 &nbsp;03 &nbsp;04&nbsp; 05 06 07 08；<asp:Label ID="lblFW" runat="server"></asp:Label>）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
