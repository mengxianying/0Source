<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SSCconfig_HeiLJ.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.SSCconfig_HeiLJ" %>
            ...
            <div style="width: 100%;">
                            ...
                            <td bgcolor="#F3F3F3">
                                ...
                                <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td width="75%">
                                            <asp:TextBox ID="txtIssue" MaxLength="10" runat="server"></asp:TextBox>
                                            （格式：2009071484）</td>
                                    </tr>
                                    <tr bgcolor="#f2f8fb">
                                        <td class="bold" width="25%">
                                        ...
                                        <td width="75%">
                                          <asp:TextBox ID="txtIssueSeq" MaxLength="10" runat="server"></asp:TextBox>
                                            （格式：523）
                                        </td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                                            开奖号码:</td>
                                        <td>
                                            <asp:TextBox ID="txtcode" runat="server" Height="20px" MaxLength="5" Width="149px"
                                                onkeyup='onkeyup="this.value=this.value.toLocaleUpperCase()"'></asp:TextBox>（格式：12345）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
                ...
                <div id="divBatchAdd" runat="server" visible="false">
                    <table style="width: 100%">
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                                批量数据录入（<font color="#ff0000">一期数据为一行，前面期号后面奖号。如：2009071484 12345）</font></td>
                        </tr>
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                ...
                <cc1:FilteredTextBoxExtender ID="ftbe" runat="server" TargetControlID="txtBatch"  FilterType="Custom" 
