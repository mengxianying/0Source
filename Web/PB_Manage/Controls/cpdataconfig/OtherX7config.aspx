<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OtherX7config.aspx.cs"
    Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.OtherX7config" %>
              ...
              <asp:HiddenField ID="HiddenField1" runat="server" Value="0" />
                ...
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="server" TargetControlID="rvd6">
                 ...
                 <asp:RangeValidator ID="rvd7" runat="server" ControlToValidate="txtCode7" MaximumValue="50"
                    MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对" Display="None"></asp:RangeValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender8" runat="server" TargetControlID="rvd7">
                </cc1:ValidatorCalloutExtender>
