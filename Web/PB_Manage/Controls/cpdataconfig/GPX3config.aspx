<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GPX3config.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.GPX3config" %>
            ...
            <div style="width: 100%;">
                        ...
                        <td class="Right_bg2">
                            <table width="95%" border="0" cellspacing="2" cellpadding="0" align="center">
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:Button ID="btnDel" runat="server" Text="删除最近开奖日期" OnClick="btnDel_Click" OnClientClick="return confirm('你确定要删除吗?');" /></td>
                                     <td align="right">
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td class="forumRow">
                                            ...
                                            <asp:TextBox ID="txtCode2" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode3")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode3" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"btnSave")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            （格式：01 02 03 04 05；<asp:Label ID="lblFW" runat="server"></asp:Label>）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
                ...
                <div id="divBatchAdd" runat="server" visible="false">
                    <table style="width: 100%">
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                                批量数据录入（<font color="#ff0000">一期数据为一行，前面期号后面奖号。如：2009040723 123）</font></td>
                        </tr>
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
