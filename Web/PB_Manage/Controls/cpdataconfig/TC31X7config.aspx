<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TC31X7config.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.TC31X7config" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Import Namespace="Pbzx.Common" %>
<html>
<head id="Head1" runat="server">
    <title>体彩31选7开奖信息管理</title>
...
<body onload="GridViewColor();">
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 100%;">
                                ...
                                <tr bgcolor="#F2F8FB">
                                   <td class="bold">
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtCode7" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtTcode")' onfocus="javascript:this.select()" ></asp:TextBox>
                                        （格式：01 02 03 04 05 06 07；范围：01-31）</td>
                                </tr>
                                <tr bgcolor="#F2F8FB">
                                    <td class="bold">
                                        特别号码:</td>
                                    <td>
                                        <asp:TextBox ID="txtTcode" runat="server" Height="20px" MaxLength="2" Width="26px" onkeyup='CheckCode(this,"btnSave")' onfocus="javascript:this.select()"></asp:TextBox>（格式：01；范围：01到29）</td>
                                </tr>
                                <tr bgcolor="#F2F8FB">
                                    <td>
                                    </td>
            ...
            <asp:RangeValidator ID="rvd1" runat="server" ControlToValidate="txtCode1" MaximumValue="31"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-31)" Display="None"></asp:RangeValidator>
            ...
            <asp:RangeValidator ID="rvd2" runat="server" ControlToValidate="txtCode2" MaximumValue="31"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-31)" Display="None"></asp:RangeValidator>
            ...
            <asp:RangeValidator ID="rvd3" runat="server" ControlToValidate="txtCode3" MaximumValue="31"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-31)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="rvd3">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd4" runat="server" ControlToValidate="txtCode4" MaximumValue="31"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-31)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" TargetControlID="rvd4">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd5" runat="server" ControlToValidate="txtCode5" MaximumValue="31"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-31)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" runat="server" TargetControlID="rvd5">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd6" runat="server" ControlToValidate="txtCode6" MaximumValue="31"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-31)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="server" TargetControlID="rvd6">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd7" runat="server" ControlToValidate="txtCode7" MaximumValue="31"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-31)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender7" runat="server" TargetControlID="rvd7">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvdT" runat="server" ControlToValidate="txtTcode" MaximumValue="31"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-31)" Display="None"></asp:RangeValidator>
