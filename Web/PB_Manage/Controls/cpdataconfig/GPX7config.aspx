<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GPX7config.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.GPX7config" %>
            ...
            <div style="width: 100%;">
                    ...
                    <tr>
                        <td class="Right_bg2">
                            <table width="95%" border="0" cellspacing="2" cellpadding="0" align="center">
                                <tr>
                                    <td align="left">
                                       <asp:Button ID="btnDivAdd" runat="server" Text="添加新的开奖信息" OnClick="btnDivAdd_Click" /></td>
                                    <td align="center">
                                       <asp:Button ID="btnBatchAdd" runat="server" Text="批量添加开奖信息" OnClick="btnBatchAdd_Click" /></td>
                                    <td align="right">
                                        <asp:Button ID="btnDel" runat="server" Text="删除最近开奖日期" OnClick="btnDel_Click"
                                            OnClientClick="return confirm('你确定要删除吗?');" /></td>
                                    <td align="right">
                                        期号：<%--<asp:Button ID="btnList" runat="server" Text="返回" OnClick="btnList_Click" />--%>
                                        <asp:TextBox ID="txt_Condition" runat="server" Width="100px"></asp:TextBox>&nbsp;
                        ...
                        <tr bgcolor="#F3F3F3">
                            <td>
                                <asp:GridView ID="MyGridView" runat="server" AutoGenerateColumns="False" Width="100%"
                                    CssClass="GridView_Table" CellPadding="0">
                                    <Columns>
                            ...
                            <td bgcolor="#F3F3F3">
                                ...
                                <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td width="75%">
                                            <asp:TextBox ID="txtIssue" runat="server" MaxLength="7"></asp:TextBox>
                                            （格式：<asp:Label ID="lblIssue" runat="server" Text=""></asp:Label>）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                                            开奖日期:
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDate" runat="server" MaxLength="19"></asp:TextBox>（格式：2004-10-08
                                            10:20:00）
                                        </td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                                            开奖号码:</td>
                                        <td class="forumRow">
                                            <asp:TextBox ID="txtCode1" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode2")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode2" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode3")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode3" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode4")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode4" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode5")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode5" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode6")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode6" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode7")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode7" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"btnSave")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <%--<asp:TextBox ID="txtCode8" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"btnSave")'
                                                onfocus="javascript:this.select()"></asp:TextBox>--%>
                                            （格式：01 02 &nbsp;03 &nbsp;04&nbsp; 05 06 07；<asp:Label ID="lblFW" runat="server"></asp:Label>）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
                ...
                <div id="divBatchAdd" runat="server" visible="false">
                    <table style="width: 100%">
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                                批量数据录入（<font color="#ff0000">一期数据为一行，前面期号后面奖号。如：<asp:Label ID="lblIssue1" runat="server"
                                    Text=""></asp:Label>&nbsp;<asp:Label ID="lblCode" runat="server" Text=""></asp:Label>）</font></td>
                        </tr>
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                ...
                <asp:RangeValidator ID="rvd6" runat="server" ControlToValidate="txtCode5" MaximumValue="100"
                    MinimumValue="01" Type="Integer" ErrorMessage="" Display="None"></asp:RangeValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="server" TargetControlID="rvd6">
                </cc1:ValidatorCalloutExtender>
                <asp:RangeValidator ID="rvd7" runat="server" ControlToValidate="txtCode5" MaximumValue="100"
                    MinimumValue="01" Type="Integer" ErrorMessage="" Display="None"></asp:RangeValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender7" runat="server" TargetControlID="rvd7">
                </cc1:ValidatorCalloutExtender>
                <%--<asp:RangeValidator ID="rvd8" runat="server" ControlToValidate="txtCode5" MaximumValue="100"
                    MinimumValue="01" Type="Integer" ErrorMessage="" Display="None"></asp:RangeValidator>--%>
<%--                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender8" runat="server" TargetControlID="rvd8">
                ...
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" TargetControlID="txtCode5"
                    FilterType="Numbers">
                </cc1:FilteredTextBoxExtender>
                
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" TargetControlID="txtCode6"
                    FilterType="Numbers">
                </cc1:FilteredTextBoxExtender>
                
                
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" TargetControlID="txtCode7"
                    FilterType="Numbers">
                </cc1:FilteredTextBoxExtender>
                
<%--                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server" TargetControlID="txtCode8"
                    FilterType="Numbers">
                </cc1:FilteredTextBoxExtender>--%>
