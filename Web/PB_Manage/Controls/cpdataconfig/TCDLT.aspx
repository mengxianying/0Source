<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TCDLT.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.TCDLT" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Import Namespace="Pbzx.Common" %>
<html>
<head id="Head1" runat="server">
    <title>体彩大乐透开奖信息</title>
...
<body onload="GridViewColor();">
    <form id="form1" runat="server">
        ...
        <div style="width: 100%;">
                        ...
                        <td class="Right_bg2">
                            <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                                <tr>                                    
                                    ...
                                    <td align="right">
                                        <asp:Button ID="btnList" runat="server" Text="开奖信息列表" OnClick="btnList_Click" />
                                    </td>
                                    <td align="right">
                        ...
                        <td>
                            <asp:GridView ID="MyGridView" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="前区号码" SortExpression="code">
                                        <ItemStyle Width="10%" />
                                        <ItemTemplate>
                                            <font color="#FF0000">
                                    ...
                                    <asp:TemplateField HeaderText="后区号码" SortExpression="code">
                                        <ItemStyle Width="7%" />
                                        <ItemTemplate>
                                            <font color="#0000FF">
                                                <%#Pbzx.Common.Method.FormartCode(Eval("code2").ToString()," ")%>
                                            </font>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                ...
                                <tr bgcolor="#F2F8FB">
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtCode7" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"btnSave")' onfocus="javascript:this.select()" ></asp:TextBox>
                                        （格式：01；范围：01-12）</td>
                                </tr>
                                 <tr bgcolor="#F2F8FB">
                                    <td>
            ...
            <asp:RangeValidator ID="rvd1" runat="server" ControlToValidate="txtCode1" MaximumValue="35"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-35)" Display="None"></asp:RangeValidator>
            ...
            <asp:RangeValidator ID="rvd2" runat="server" ControlToValidate="txtCode2" MaximumValue="35"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-35)" Display="None"></asp:RangeValidator>
            ...
            <asp:RangeValidator ID="rvd3" runat="server" ControlToValidate="txtCode3" MaximumValue="35"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-35)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="rvd3">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd4" runat="server" ControlToValidate="txtCode4" MaximumValue="35"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-35)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" TargetControlID="rvd4">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd5" runat="server" ControlToValidate="txtCode5" MaximumValue="35"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-35)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" runat="server" TargetControlID="rvd5">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd6" runat="server" ControlToValidate="txtCode6" MaximumValue="12"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-12)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="server" TargetControlID="rvd6">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd7" runat="server" ControlToValidate="txtCode7" MaximumValue="12"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-12)" Display="None"></asp:RangeValidator>
