<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TC7XCconfig.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.TC7XCconfig" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<html>
<head runat="server">
    <title>体彩七星彩开奖信息管理</title>
                            ...
                            <td bgcolor="#F3F3F3">
                                ...
                                <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCode" MaxLength="7" runat="server"></asp:TextBox>
                                            （格式：1234567&nbsp;范围（0-9））</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td>
                                        </td>
