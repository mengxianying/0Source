<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TC22X5config.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.TC22X5config" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Import Namespace="Pbzx.Common" %>
<html>
<head id="Head1" runat="server">
    <title>体彩22选5开奖信息管理 </title>
...
<body onload="GridViewColor();">
    <form id="form1" runat="server">
        ...
        <div style="width: 100%;">
                                ...
                                <tr bgcolor="#F2F8FB">
                                    ...
                                    <td class="forumRow">
                                       <asp:TextBox ID="txtCode1" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode2")' onfocus="javascript:this.select()"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txtCode5" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"btnSave")' onfocus="javascript:this.select()"></asp:TextBox>
                                        （格式：01 02 03 04 05；范围：01到22）</td>
                                </tr>
                                <tr bgcolor="#F2F8FB">
                                    <td>
                                    </td>
            ...
            <asp:RangeValidator ID="rvd1" runat="server" ControlToValidate="txtCode1" MaximumValue="22"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-22)" Display="None"></asp:RangeValidator>
            ...
            <asp:RangeValidator ID="rvd2" runat="server" ControlToValidate="txtCode2" MaximumValue="22"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-22)" Display="None"></asp:RangeValidator>
            ...
            <asp:RangeValidator ID="rvd3" runat="server" ControlToValidate="txtCode3" MaximumValue="22"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-22)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="rvd3">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd4" runat="server" ControlToValidate="txtCode4" MaximumValue="22"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-22)" Display="None"></asp:RangeValidator>
            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" TargetControlID="rvd4">
            </cc1:ValidatorCalloutExtender>
            <asp:RangeValidator ID="rvd5" runat="server" ControlToValidate="txtCode5" MaximumValue="22"
                MinimumValue="01" Type="Integer" ErrorMessage="号码范围不对(01-22)" Display="None"></asp:RangeValidator>
