<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GPX5config.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.GPX5config" %>
                                    ...
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td class="forumRow">
                                            ...
                                            <asp:TextBox ID="txtCode4" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"txtCode5")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
                                            <asp:TextBox ID="txtCode5" runat="server" Width="26px" MaxLength="2" onkeyup='CheckCode(this,"btnSave")'
                                                onfocus="javascript:this.select()"></asp:TextBox>
