<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TCPL35config.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.TCPL35config" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Import Namespace="Pbzx.Common" %>
<html>
<head id="Head1" runat="server">
    <title>体彩排列3、5开奖信息</title>
                        ...
                        <td>
                            <asp:GridView ID="MyGridView" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="排列3开奖号码" SortExpression="code">
                                        <ItemStyle Width="13%" />
                                        <ItemTemplate>
                                            <font color="#990033">
                                                <%#Eval("code3")%>
                                    ...
                                    <asp:TemplateField HeaderText="排列5开奖号码" SortExpression="code">
                                        <ItemStyle Width="13%" />
                                        <ItemTemplate>
                                            <font color="#FF0000">
                                                <%#Eval("code5")%>
                            ...
                            <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                ...
                                <tr bgcolor="#F2F8FB">
                                    ...
                                    <td style="height: 28px">
                                        <asp:TextBox ID="txtCode1" runat="server" Width="142px" MaxLength="5"></asp:TextBox>
                                        （格式：12345&nbsp;范围：（0 - 9））</td>
                                </tr>
                                <tr bgcolor="#F2F8FB">
                                    <td>
