<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Other7XCconfig.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.Other7XCconfig" %>
                                ...
                                <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                                    <tr bgcolor="#F2F8FB">
                                        ...
                                        <td width="75%">
                                            ...
                                            （格式：<asp:Label ID="lblIssue" runat="server"></asp:Label>）</td>
                                    </tr>
                                    <tr bgcolor="#F2F8FB">
                                        <td class="bold">
                                            开奖日期:
