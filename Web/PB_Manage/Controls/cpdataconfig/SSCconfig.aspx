<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SSCconfig.aspx.cs" Inherits="Pbzx.Web.PB_Manage.Controls.cpdataconfig.SSCconfig" %>
            ...
            <div style="width: 100%;">
                ...
                <div id="divBatchAdd" runat="server" visible="false">
                    <table style="width: 100%">
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
                                批量数据录入（<font color="#ff0000">一期数据为一行，前面期号后面奖号。如：2009040723 12345）</font></td>
                        </tr>
                        <tr>
                            <td align="center" class="forumRow" colspan="2">
