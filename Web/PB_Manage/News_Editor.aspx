<%@ Page Language="C#" AutoEventWireup="true" Codebehind="News_Editor.aspx.cs" Inherits="Pbzx.Web.PB_Manage.News_Editor"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        ///加载网页关键字
        function LoadMetaDesc() {

            createHTTP();
            xmlhttp.open("GET", "/reg.aspx?GetMetaDesc=11", true);
            xmlhttp.onreadystatechange = function () {
//                if (xmlhttp.readystate == 4 && xmlhttp.status == 200) {
                    var resultUrl = xmlhttp.responseText;
                    document.getElementById('<%=txtKey.ClientID%>').value = resultUrl;
//                }
            };
            xmlhttp.send(null);
        }
                ...
                <tr>
                    <td class="Right_bg1">
                        <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                                <td align="CENTER">
                                    <a href="News_Manage.aspx" class="zilan">新闻管理</a> |&nbsp; <a href="News_Editor.aspx"
                                        class="zilan">添加新闻</a>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        <tr>
                                            <td width="91%" align="left">
                                                当前位置：软件信息管理>><asp:Label ID="lblAction" runat="server"></asp:Label>新闻</td>
                        ...
                        <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                            <tr bgcolor="#F2F8FB">
                                <td class="bold" width="15%">
                                    新闻标题:</td>
                                <td width="85%">
                                    <asp:TextBox ID="txtTitle" runat="server" Width="475px" MaxLength="200"></asp:TextBox><span
                                        style="color: #ff0000">*</span>(100字以内)<asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                            runat="server" ControlToValidate="txtTitle" ErrorMessage="标题不能为空"></asp:RequiredFieldValidator></td>
                            </tr>
                            <tr bgcolor="#F2F8FB">
                                <td class="bold">
                                    新闻短标题:</td>
                                <td>
                                    <asp:TextBox ID="txtShortTitle" runat="server" Width="260px" MaxLength="10"></asp:TextBox><span
                                        style="color: #ff0000">*</span>(10字以内)</td>
                            </tr>
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    网页关键字:</td>
                                <td>
                                    <asp:TextBox ID="txtKey" runat="server" MaxLength="200" Width="475px" TextMode="MultiLine"></asp:TextBox>(200字以内)
                                    <input type="button" value="获取关键字" onclick="javascript:LoadMetaDesc()" style="width: 101px" />
                            ...
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    网页内容描述:</td>
                                <td>
                                    <asp:TextBox ID="txtMetadesc" runat="server" MaxLength="200" Width="475px" TextMode="MultiLine"></asp:TextBox>(200字以内)</td>
                            </tr>
                            <tr bgcolor="#F2F8FB">
                                <td class="bold">
                                    作者:</td>
                            ...
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    文章来源:</td>
                                <td>
                                    <asp:TextBox ID="txtSource" runat="server" Width="341px"></asp:TextBox></td>
                            </tr>
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    来源地址:</td>
                                <td>
                                    <asp:TextBox ID="txtSourceUrl" runat="server" Width="341px"></asp:TextBox></td>
                            </tr>
                           <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    微博图片地址:</td>
                            ...
                            <%--    <tr bgcolor="#F2F8FB">
                                ...
                                <td style="height: 58px">
                                    ...
                                    (备注：如果上传图片，请将图片上传到UploadFiles文件夹下的News文件夹中)</td>
                            </tr>--%>
                            <tr bgcolor="#F2F8FB">
                            ...
                            <tr id="Tr2" runat="server" bgcolor="#F1F1F1">
                                <td class="bold">
                                    点击次数:</td>
                                <td>
                                    <asp:TextBox ID="txtHits" runat="server" Width="60px" Text="0"></asp:TextBox></td>
                            </tr>
                            <tr bgcolor="#F2F8FB">
                                <td class="bold">
                                    添加(修改)时间:</td>
                            ...
                            <tr bgcolor="#F2F8FB">
                                ...
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp; 置顶:<asp:RadioButtonList ID="rbtnIsTop" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="2">首固</asp:ListItem>
                                        <asp:ListItem Value="1">次固</asp:ListItem>
                                        <asp:ListItem Selected="True" Value="0">不固</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                            </tr>
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    是否首页显示:</td>
                                <td>
                                    <asp:CheckBox ID="chbShowIndex" runat="server" Checked="True" Text="是" /><span style="color: #0000ff">（如果选中的话将在首页显示。）</span></td>
                            </tr>
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    是否软件内嵌:</td>
                                <td>
                                    <asp:CheckBox ID="chbShowInSoft" runat="server" Checked="false" Text="是" /><span
                                        style="color: #0000ff">（如果选中的话将在软件内嵌页面显示。）</span></td>
                            </tr>
                               <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    微信发送状态</td>
                                <td>
                                      <asp:TextBox ID="txtInWeiXin" runat="server" Width="60px" Text="0"></asp:TextBox><span
                                        style="color: #0000ff">（-1为正在发送；0为可以发送；1为已经发送完成；大于1为不允许发送；）</span></td>
                            </tr>
                            <tr bgcolor="#F2F8FB">
