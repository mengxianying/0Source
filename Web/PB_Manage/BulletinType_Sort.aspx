<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulletinType_Sort.aspx.cs" Inherits="Pbzx.Web.PB_Manage.BulletinType_Sort" %>
                ...
                <tr>
                    <td bgcolor="#F3F3F3">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="4">
                            <tr>
                                <td align="CENTER">
                                    <a href="BulletinType_Manage.aspx">网站公告类别管理</a>&nbsp; | &nbsp;<a href="BulletinType_Sort.aspx">网站公告类别显示排序</a>&nbsp;
                                    |&nbsp;
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpLinks" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:ObjectDataSource ID="ObjDCProduct" runat="server" DataObjectTypeName="Pbzx.Model.PBnet_BulletinType"
                                    SelectMethod="GetProductListSort" TypeName="Pbzx.BLL.PBnet_BulletinType" UpdateMethod="Update">
                                    <SelectParameters>
