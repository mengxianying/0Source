<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UsersMsDel.aspx.cs" Inherits="Pbzx.Web.PB_Manage.UsersMsDel" %>
            ...
            <tr bgcolor="#ffffff">
                <td>
                    <asp:GridView ID="MyGridView" runat="server" Width="100%" AutoGenerateColumns="False"
                        DataKeyNames="ID" CssClass="GridView_Table">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="主题">
                                <ItemTemplate>
                                  <%# FormartTitleA(Eval("ID"), Eval("title"), Eval("sender"), Eval("incept"))%>
                                </ItemTemplate>
                       ...
                       <%--<EmptyDataTemplate>
                            <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#CED7F7">
                                <tr>
                    ...
                    <table cellpadding="0" cellspacing="1" width="80%">
                        <tr>
                            <td align="right">
                                ...
                                <asp:Button ID="btnSC" runat="server" Text="删除垃圾箱" OnClientClick="{if(confirm('确定删除选定的纪录吗?')){return true;}return false;}"
                                    OnClick="btnSC_Click" Width="100px" Height="26px" />&nbsp;
                                <asp:Button ID="btnQK" runat="server" Text="清空垃圾箱" OnClientClick="{if(confirm('确定清除垃圾箱所有的纪录吗?')){return true;}return false;}"
