<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Bbs_Userpost.aspx.cs" Inherits="Pbzx.Web.PB_Manage.CST.Bbs_Userpost" %>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#E7A427"
                ...
                <tr>
                    <td bgcolor="#F7FBFF" align="left">
                        &nbsp;<uc3:Uc_UserPost id="Uc_UserPost1" runat="server"></uc3:Uc_UserPost></td>
                </tr>
            </table>
                    ...
                    <td>
                        <asp:GridView ID="MyGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="跟贴对象" SortExpression="ParentID">
                                    <ItemTemplate>
                                        &nbsp;<a href="Bbs_Userpost.aspx?ParentID=<%#Eval("ParentID") %>"><%# Eval("ParentID")%></a>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left" Width="15%" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="版面" SortExpression="BoardID">
                                    <ItemTemplate>
                                        &nbsp;<a href="Bbs_Userpost.aspx?BoardID=<%#Eval("BoardID") %>"><%# BoardNameByID(Eval("BoardID"))%></a>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="是否精华" SortExpression="isbest">
                                    <ItemTemplate>
                                        &nbsp;<a href="Bbs_Userpost.aspx?isbest=<%#Eval("isbest") %>"><%# Eval("isbest").ToString() == "1" ? "精" : "--"%></a>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="12%" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="状态" SortExpression="locktopic">
                                    <ItemTemplate>
                                        &nbsp;<a href="Bbs_Userpost.aspx?locktopic=<%#Eval("locktopic") %>"><%# Pbzx.Web.WebFunc.CheckBbsPostStats(Eval("locktopic"))%></a>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left" Width="8%" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="帖子ID" SortExpression="AnnounceID">
                                    <ItemTemplate>
                                        &nbsp;<a href="Bbs_Userpost.aspx?AnnounceID=<%#Eval("AnnounceID") %>"><%# Eval("AnnounceID")%></a>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left" Width="9%" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="表" SortExpression="PostTable">
                                    <ItemTemplate>
                                        &nbsp;<a href="Bbs_Userpost.aspx?PostTable=<%#Eval("PostTable") %>"><%# Eval("PostTable")%></a>
                                    </ItemTemplate>
