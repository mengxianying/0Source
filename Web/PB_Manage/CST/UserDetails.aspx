<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UserDetails.aspx.cs" Inherits="Pbzx.Web.PB_Manage.CST.UserDetails" %>
                        ...
                        <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                            <tr bgcolor="#F2F8FB">
                                <td class="bold">
                                    论坛昵称:</td>
                                <td>
                                    <asp:TextBox ID="txtBss" runat="server"></asp:TextBox><span class="red12"></span></td>
                                <td class="bold">
                                    客户姓名:</td>
                                <td>
                            ...
                            <tr bgcolor="#F2F8FB">
                                <td class="bold">
                                    客户地址:</td>
                                <td>
                                    <asp:TextBox ID="txtAddress" runat="server" Width="240px"></asp:TextBox><span style="color: #ff0000"></span></td>
                                <td class="bold">
                                    客户状态:</td>
                                <td>
