<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UsersMs.aspx.cs" Inherits="Pbzx.Web.PB_Manage.UsersMs" %>
...
<body onload="GridViewColor();">
    <form id="form1" runat="server">
        <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#E7A427" class="MT">
            <tr>
                <td bgcolor="#F3F3F3">
                                ...
                                <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                                    <tr>
                                        <td width="91%" align="left">
                                            当前位置：收信箱<%--<asp:Label ID="labAction" runat="server" />--%>管理</td>
        ...
        <table width="98%" border="0" cellpadding="1" cellspacing="1" bgcolor="#7694D2" class="MT">
            <tr bgcolor="#ffffff">
                <td>
                    <asp:GridView ID="MyGridView" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="已读">
                                <ItemTemplate>
                                    <%#Eval("flag").ToString() == "0" ? "<img src='/images/web/m_news.gif' alt='未读' />" : "<img src='/images/web/m_olds.gif' alt='已读' />"%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="主题">
                                <ItemTemplate>
                                    <a title="阅读短消息" href="#" onclick="window.open('MsgDetail.aspx?id=<%#Eval("ID")%>&action=read','','height=500, width=600, top='+(screen.height-500)/2+',left='+(screen.width-800)/2+', toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');">
                    ...
                    <table cellpadding="0" cellspacing="1" width="80%">
                        <tr>
                            <td align="right">
                                ...
                                <asp:Button ID="btnQK" runat="server" Text="清空收信箱" OnClientClick="{if(confirm('确定清除收信箱所有的纪录吗?')){return true;}return false;}"
