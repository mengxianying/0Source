<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NewsType_Manage.aspx.cs"
    Inherits="Pbzx.Web.PB_Manage.NewsType_Manage" EnableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
                                    ...
                                    <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        <tr>
                                            <td width="91%" align="left">
                                                当前位置：<asp:Label ID="lblAction" runat="server"></asp:Label>新闻类别</td>
        ...
        <div id="divList" runat="server">
                ...
                <tr>
                    <td bgcolor="#F3F3F3">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="4">
                            <tr>
                                <td align="CENTER">
                                    <asp:LinkButton ID="btn_gl" runat="server" OnClick="btn_gl_Click">管理新闻类别</asp:LinkButton>&nbsp;
                                    |&nbsp;
                                    <asp:LinkButton ID="btn_add" runat="server" OnClick="btn_add_Click">添加新闻类别</asp:LinkButton>
                                    &nbsp;|&nbsp; <a href="#" onclick="OpenEdite('PBnet_NewsType','IntNewsTypeID','VarTypeName','IntOrderID','IntSortID','','800','600')">
                                        新闻类别显示排序</a>&nbsp; |&nbsp; &nbsp;<asp:LinkButton ID="lbtnUpdateNews" runat="server"
                                            OnClick="lbtnUpdateNews_Click">更新新闻资讯首页</asp:LinkButton></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr bgcolor="#ffffff">
                    <td>
                        <asp:GridView ID="MyGridView" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                            CellPadding="0" Width="100%" DataKeyNames="IntNewsTypeID"
            ...
            <asp:ObjectDataSource ID="odsMaster" runat="server" SelectMethod="GetListBySort"
                TypeName="Pbzx.BLL.PBnet_NewsType"></asp:ObjectDataSource>
