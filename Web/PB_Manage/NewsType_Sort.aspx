<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NewsType_Sort.aspx.cs"
    Inherits="Pbzx.Web.PB_Manage.NewsType_Sort" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="4">
                            <tr>
                                <td align="CENTER" style="height: 28px">
                                    <a href="NewsType_Manage.aspx">新闻类别管理</a>&nbsp; |&nbsp; <a href="NewsType_Sort.aspx">新闻类别显示排序</a>
                                    |
                                    <asp:LinkButton ID="lbtnUpdateNews" runat="server" OnClick="lbtnUpdateNews_Click">更新新闻资讯首页</asp:LinkButton></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpLinks" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:ObjectDataSource ID="ObjDCProduct" runat="server" DataObjectTypeName="Pbzx.Model.PBnet_NewsType"
                                    SelectMethod="GetProductListSort" TypeName="Pbzx.BLL.PBnet_NewsType" UpdateMethod="Update">
                                    <SelectParameters>
