<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Bulletin_Editor.aspx.cs"
    Inherits="Pbzx.Web.PB_Manage.Bulletin_Editor" %>
                ...
                <tr>
                    <td class="Right_bg1">
                        <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                                <td align="CENTER">
                                    <a href="Bulletin_Manage.aspx" class="zilan">公告管理</a> |&nbsp; <a href="Bulletin_Editor.aspx"
                                        class="zilan">添加公告</a>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        <tr>
                                            <td width="91%" align="left">
                                                当前位置：公告管理>><asp:Label ID="lblAction" runat="server"></asp:Label>公告</td>
                        ...
                        <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                            ...
                            <tr bgcolor="#f2f8fb">
                                <td class="bold" width="15%">
                                    所属频道:</td>
                                <td width="85%">
                                    <asp:DropDownList ID="ddlChannel" runat="server" Width="168px">
                                    </asp:DropDownList></td>
                            </tr>
                        </table>
                        <table width="100%" cellpadding="2" cellspacing="1" bgcolor="#CED7F7">
                            ...
                            <tr bgcolor="#F2F8FB">
                                <td class="bold">
                                    公告短标题:</td>
                                <td>
                                    <asp:TextBox ID="txtShortTitle" runat="server" Width="200px" MaxLength="15"></asp:TextBox><span
                            ...
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    公告关键字:</td>
                                <td>
                                    <asp:TextBox ID="txtKey" runat="server" MaxLength="200" Width="475px" TextMode="MultiLine"></asp:TextBox>(200字以内)</td>
                            </tr>
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    网页内容描述:</td>
                            ...
                            <%--  <tr bgcolor="#F2F8FB">
                                ...
                                <td style="height: 58px">
                                        ...
                                        <tr bgcolor="#F2F8FB">
                                            <td>
                                                <span onmouseover="javascript:ShowDivPic(this,document.form1.txtThumb.value,'.jpg',1);"
                                                    ...
                                                    <asp:TextBox ID="txtThumb" runat="server" Width="268px"></asp:TextBox></span>
                                            </td>
                                            <td>
                                    ...
                                    (备注：如果上传图片，请将图片上传到UploadFiles文件夹下的Bulletin文件夹中)</td>
                            </tr>--%>
                               <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    微博图片地址:</td>
                            ...
                            <tr bgcolor="#F2F8FB">
                                <td class="bold">
                                    显示位置:</td>
                                <td>
                                    <asp:DropDownList ID="ddlIntDisPosition" runat="server" Width="168px">
                                        <asp:ListItem Selected="True" Value="0">不限</asp:ListItem>
                                    </asp:DropDownList><span style="color: Red;">此功能为特殊需要所准备，可以将此条新闻显示在某个位置</span></td>
                            </tr>
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    是否首页显示:</td>
                            ...
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    是否软件内嵌:</td>
                                <td>
                                    <asp:CheckBox ID="chbShowInSoft" runat="server" Checked="true" Text="是" /><span style="color: #0000ff">（如果选中的话将在软件内嵌页面显示。）</span></td>
                            </tr>
                            <tr bgcolor="#f2f8fb">
                                <td class="bold">
                                    微信发送状态</td>
