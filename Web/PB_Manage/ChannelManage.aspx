<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ChannelManage.aspx.cs"
    Inherits="Pbzx.Web.PB_Manage.ChannelManage" %>
    ...
    <form id="form1" runat="server">
            ...
            <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#7694D2"
                ...
                <tr bgcolor="#F2F8FB">
                    <td class="bold">
                        Aspx页面地址:</td>
                    <td align="left">
                        <asp:TextBox ID="txtAspx" runat="server" Width="280"></asp:TextBox>
                    </td>
                </tr>
                <tr bgcolor="#F2F8FB">
                    <td class="bold">
                        最终html页面地址:</td>
                    <td align="left">
                        <asp:TextBox ID="txtHtml" runat="server" Width="280"></asp:TextBox>
                    </td>
                </tr>
                <tr bgcolor="#F2F8FB">
                    <td>
        ...
        <div id="divList" runat="server">
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#7694D2">
                <tr>
                    <td bgcolor="#F3F3F3" style="height: 78px">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="4">
                            <tr>
                                <td align="CENTER">
                                    <a href="#" onclick="OpenEdite('PBnet_UrlMaping','MapID','PageName','Html','OrderID','and Depth=0 and TypeID=0 ','800','600')">
                                        主栏目显示排序</a> |&nbsp;
                                    <asp:LinkButton ID="btn_add" runat="server" OnClick="btn_add_Click">添加栏目信息</asp:LinkButton></td>
                            </tr>
                        </table>
                    </td>
                </tr>
