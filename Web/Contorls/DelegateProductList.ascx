<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DelegateProductList.ascx.cs" Inherits="Pbzx.Web.Contorls.DelegateProductList" %>
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CartID,RegType"
    ...
    Width="100%" CssClass="GridView_Table1" BorderWidth="0px">
