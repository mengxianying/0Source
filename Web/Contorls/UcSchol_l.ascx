<%@ Control Language="C#" AutoEventWireup="true" Codebehind="UcSchol_l.ascx.cs" Inherits="Pbzx.Web.Contorls.UcSchol_l" %>
    ...
    <div class="content">
        <div>
            <asp:DataList ID="dtType" runat="server" CaptionAlign="Left" ShowFooter="False" ShowHeader="False"
                ...
                <ItemTemplate>
                    &nbsp;·<a href='#' onclick="GetThisSrc(<%#Eval("IntNewsTypeID")%>)"><%#Eval("VarTypeName")%></a>
                </ItemTemplate>
                <FooterTemplate>
                </FooterTemplate>
...
<div class="C_box  C_l1 MT">
    ...
    <div class="content">
        <uc2:UcSchoolHot ID="UcSchoolHot1" runat="server" IsHot="1" TitleLength="13"></uc2:UcSchoolHot>
    </div>
</div>
...
<div class="C_box  C_l1 MT" runat="server" id="divLeft1">
    <div class="title">
        <p>
            <asp:Label ID="lblLeft1" runat="server" Text=""></asp:Label></p>
    </div>
    <div class="content">
        <uc3:SchoolOneTitleByType ID="SchoolOneTitleByTypeLeft1" IsHot="0" TitleLength="13"
...
<div class="C_box  C_l1 MT" runat="server" id="divLeft2">
    <div class="title">
        <p>
            <asp:Label ID="lblLeft2" runat="server" Text=""></asp:Label></p>
    </div>
    <div class="content">
        <uc3:SchoolOneTitleByType ID="SchoolOneTitleByTypeLeft2" IsHot="0" TitleLength="13"
            runat="server"></uc3:SchoolOneTitleByType>
    </div>
</div>
<uc7:UcPicAds ID="UcPicAdsLeft3" runat="server" PlaceType="软件学院首页左三" /><uc6:UcJsADs ID="UcJsADsLeft3" runat="server" PlaceType="软件学院首页左三JS" />
<div class="C_box  C_l1 MT" runat="server" id="divLeft3">
    <div class="title">
        <p>
            <asp:Label ID="lblLeft3" runat="server" Text=""></asp:Label></p>
    </div>
    <div class="content">
        <uc3:SchoolOneTitleByType ID="SchoolOneTitleByTypeLeft3" IsHot="0" TitleLength="13"
            runat="server"></uc3:SchoolOneTitleByType>
    </div>
</div>
<!--在线联系--->
<div class="C_l2 MT">
    ...
    <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="C_QQBG">
            <tr>
                <td>
