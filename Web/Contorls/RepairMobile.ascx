<%@ Control Language="C#" AutoEventWireup="true" Codebehind="RepairMobile.ascx.cs" Inherits="Pbzx.Web.Contorls.RepairMobile" %>
        ...
        <tr>
          ...
          <tr>
            ...
            <td align="left" style="height: 40px">
                ...
                <iframe name="Runwin" id="Iframe1" style="display:none;"></iframe>
                <script>
                    function tosendsms() {
