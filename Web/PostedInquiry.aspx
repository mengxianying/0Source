<%@ Page Language="C#" AutoEventWireup="true" Codebehind="PostedInquiry.aspx.cs"
    Inherits="Pbzx.Web.PostedInquiry" EnableEventValidation="false" %>
                                    ...
                                    <td align="left" bgcolor="#FCFCFC">
                                        <table width="90%" border="0" align="center" cellpadding="6" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <strong>用户名:</strong>
                                                    <asp:TextBox ID="txtName" runat="server" Width="160px" MaxLength="12"></asp:TextBox>
                                                    <asp:Label ID="lblName" runat="server"></asp:Label>
                                                    &nbsp;&nbsp;<strong>软件名称:</strong>
                                                    <asp:DropDownList ID="ddlSoft" runat="server">
                                                    </asp:DropDownList>&nbsp;&nbsp;
                                                    <asp:Button ID="btnUp" runat="server" Text="上周帖子查询" OnClick="btnUp_Click" CssClass="buy_btnbg" />
                                                    &nbsp;&nbsp;
                                                    <asp:Button ID="btnThis" runat="server" Text="本周帖子查询" OnClick="btnThis_Click" CssClass="buy_btnbg" /></td>
                                            </tr>
                                        </table>
