<%@ Page Language="C#" AutoEventWireup="true" Inherits="manage_Templet_Upload" ResponseEncoding="utf-8"
    Codebehind="Upload.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>文件上传__<%Response.Write(Pbzx.Common.UIConfig.HeadTitle); %></title>
    <link href="/css/<%Response.Write(Pbzx.Common.UIConfig.CssPath()); %>/css/css.css"
...
<body>
    <form id="f_Upload" runat="server" method="post" action="" enctype="multipart/form-data">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" background="../../sysImages/<%Response.Write(Pbzx.Common.UIConfig.CssPath()); %>/admin/reght_1_bg_1.gif">
            <tr>
