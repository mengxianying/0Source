...
<head>
<title><%Response.Write(Pbzx.Common.UIConfig.HeadTitle); %></title>
<link href="/css/<%Response.Write(Pbzx.Common.UIConfig.CssPath()); %>/css/css.css" rel="stylesheet" type="text/css" />
</head>
