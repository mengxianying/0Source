...
function show(type,obj,title,label_width,height)
{
    ...
    <td style=\"width:20px\">\
    <img src=\"/css/blue/normal/close.gif\" style=\"cursor:pointer;\" title=\"close\" onclick=\"closediv($('LabelDivid'));\" />\
    </td>\
    </tr>\
    </table>\
    </div>\
    ...
    {
        case "Synchronous":
            label_temp3 = label_temp1 + "/Synchronous.aspx"+ label_temp2;
            break;
        case "List":
            label_temp3 = label_temp1 + "/PB_Manage/PopFram/FrmSoftClassInfo.aspx?SoftwareType=" +title+ label_temp2;
            break;
        case "simpleList":
