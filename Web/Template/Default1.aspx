...
<head>
    <title>拼搏在线彩神通软件 - 彩神通软件官方网站</title>
        ...
        <div class="bodyw MT5">
            <div class="D_L1">
                <div class="D_Award box2">
                    <div class="title">
                        <p>
                           <a href="javascript:void(0)" onclick="refresh()" title="刷新最新开奖信息" class="kai more">刷新最新开奖信息</a><span><a href='http://<%= ConfigurationManager.AppSettings["WAPURL"] %>' target='_blank' class="kai more">手机查看开奖信息</a></span>
                        </p>
                    </div>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="left" height="27" valign="bottom">
                                                &nbsp;<span id="spPriceZi">网络版：</span><span id="spWLP"
                                                    class="red">310元/3月&nbsp;560元/6月&nbsp;990元/年&nbsp;</span><span id='spPriceDay' class="blue">按天：<font color="red">7元/天</font>&nbsp;</span>
                                            </td>
                                        </tr>
                                    </table>
                                </li>
                                        ...
                                        <td align="center">
                                            <asp:GridView ID="zhuanye" runat="server" Width="96%" DataKeyNames="pb_SoftID" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="单机版">
                                                        <ItemTemplate>
                                                            <%#Eval("pb_DemoUrl")%>
                                                        </ItemTemplate>
                ...
                <div class="MT Bodywidth">
                    ...
                    <div class="D_RC2">
                        ...
                        <div class="box4 D_public MT D_News" style="margin-top:9px;">
                            <div class="title">
                                <p>
                                    <a href="http://<%= ConfigurationManager.AppSettings["BBSURL"] %>/index.asp" class="more" target="_blank">更多>></a><span>热点论坛</span></p>
                            </div>
                            <div class="content" style="text-align: left;">
                                <div>
