<%@ Page Language="C#" AutoEventWireup="true" Codebehind="PWD_BuyAsk.aspx.cs" Inherits="Pbzx.Web.UserCenter.PWD_BuyAsk" %>
                ...
                <table width="800" border="0" cellpadding="4" cellspacing="1" bgcolor="#DDDDDD" align="center">
                    ...
                    <tr>
                        <td width="200" align="right" bgcolor="#F6F6F6">
                            请输入原交易密保答案：</td>
                        <td width="605" align="left" bgcolor="#FFFFFF">
                            <asp:TextBox ID="txtMBDA" runat="server" MaxLength="100" Width="180px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                    ControlToValidate="txtPassWordAnswer" ValidationGroup="baseinfo" SetFocusOnError="True">*</asp:RequiredFieldValidator><span
                                        class="uc_font_gray">请输入您的原交易密保答案</span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" bgcolor="#FFFFFF" align="center">
                            <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    ...
                                    <td width="25%">
                                        &nbsp;&nbsp;
                                        <asp:Button ID="btnKSYZ" runat="server" CssClass="page_Save"  OnClick="btnKSYZ_Click" Text="下一步" /></td>
                                    <td width="50%">
                                        &nbsp;</td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        ...
                        <td width="605" align="left" bgcolor="#FFFFFF">
                            <asp:TextBox ID="txtPassWordAnswer" runat="server" ValidationGroup="baseinfo" Width="157px"
                                MaxLength="100"></asp:TextBox><asp:RequiredFieldValidator ID="vPasswordanswer" runat="server"
                                    ControlToValidate="txtPassWordAnswer" ValidationGroup="baseinfo" SetFocusOnError="True">*</asp:RequiredFieldValidator><span
                                        class="uc_font_gray">请输入您的密码保护答案</span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" bgcolor="#FFFFFF" align="center">
