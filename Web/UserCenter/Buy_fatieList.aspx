                            ...
                            <table width="96%" border="0" align="center" cellpadding="6" cellspacing="1" bgcolor="#ECECEC">
                                <tr>
                                    <td align="left" bgcolor="#FCFCFC">
                                        ...
                                        <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC" id="tb1" runat="server">
   <%--                                         <tr height="22">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="6">
                                            <tr>
                                                <td>
                                                    说明:<font color="0000FF">&nbsp;&nbsp;&nbsp;主帖总数、跟帖总数、精华贴数和发贴跟贴天数必须同时满足“发贴标准”的要求。</font><br />
