<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UsersMs.aspx.cs" Inherits="Pbzx.Web.UserCenter.UsersMs" %>
            ...
            <table width="800" border="0" align="center" cellpadding="3" cellspacing="0" class="uc_MT2">
                <tr>
                    ...
                    <td width="780" class="uc_xia" valign="bottom">
                        <span class="uc_font_blue14"><asp:Label ID="lblTitle" runat="server" Text=""></asp:Label></span></td>
                </tr>
            </table>
