                    ...
                    <table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="93%" align="left" class="order_18black">
                                您的订单<span color="red"><%=c_order %></span> 已经提交，您需要支付：<span class="order_14red"><%=c_orderamount.ToString("0.00")%>元
                                    </span>；<br/>如果您已汇款，请点击 “<a href="/UserCenter/User_Center.aspx?myUrl=OrderList.aspx" target="_blank" style="font-size:18px;">我的订单</a>”进行汇款确认。</td>
                        </tr>
                        <tr>
                            <td align="center">
                                &nbsp;</td>
                            <td align="left">
                                款项到达拼搏在线彩神通软件帐户后，我们将会为您开通软件或邮寄软件狗，购买新软件狗的用户可以在“<a href="/UserCenter/User_Center.aspx?myUrl=OrderList.aspx" target="_blank">我的订单</a>”中点击订单号打开订单详细页面，然后点击“开通临时使用”按钮可以免费获得临时的软件使用。</td>
                        </tr>
                    </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:12px; color:Red">
                                            * 当您付款完毕后，需要在“<a href="/UserCenter/User_Center.aspx?myUrl=OrderList.aspx" target="_blank">我的订单</a>”中选择您的订单，然后点击订单号对您的订单继续处理！<br />                                   
                                            * 当您的订单通过管理员审核之后，我们会给您一个注册码，请登录“<a href="/UserCenter/User_Center.aspx" target="_blank">用户中心</a>”，在“<a
