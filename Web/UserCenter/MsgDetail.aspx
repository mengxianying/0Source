<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MsgDetail.aspx.cs" Inherits="Pbzx.Web.UserCenter.MsgDetail" %>
                        ...
                        <table width="100%" border="0" cellpadding="4" cellspacing="1" id="tbAlert" runat="server"
                            ...
                            <tr>
                                <td align="center" bgcolor="#F6F6F6" class="uc_font_blue">
                                    <img src="../Images/Web/UC_btcolse.jpg" border="0" onclick="window.close();" alt="关闭"
                                        style="cursor: pointer;" />
