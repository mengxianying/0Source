 ...
 */
    ...
    void Page_Load(Object sender, EventArgs E)
    {
        ...
        else
        {
            ...
            Lab_orderAmount.Text = Convert.ToDecimal(orderAmount).ToString("0.00");
...
<html>
<head>
    <title>快钱人民币网关支付结果 - 拼搏在线彩神通软件</title>
            ...
            <tr>
                ...
                <td width="970" align="center" bgcolor="#FFFFFF">
                    ...
                    <table width="85%" border="0" cellspacing="0" cellpadding="4">
                        ...
                        <tr>
                            <td align="right" class="order_xia buy_okbiao" style="height: 24px">
                                支付结果：</td>
                            <td align="left" class="order_xia buy_okshuo" colspan="3" style="height: 24px">
                                     <font color="#e10900"><asp:Label ID="Lab_msg" runat="Server" /></font></td>
                        </tr>
                        <%
                            }
                        %>
