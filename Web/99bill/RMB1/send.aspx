 ...
 */
    ...
    void Page_Load(Object sender, EventArgs E)
    {
        ...
        bgUrl.Value = Pbzx.Common.WebInit.webBaseConfig.WebUrl + "99bill/RMB1/receive.aspx";
        ...
        Pbzx.Common.ErrorLog.WriteLogMeng("在线交易", "快钱订单开始，订单号：" + strOrderID, true, true);
        ...
        signMsg.Value = CerRSASignature(signMsgVal, prikey_path, CertificatePW, 2);
                ...
                <table width="90%" border="0" cellpadding="8" cellspacing="0">
                    <tr>
                        <td class="order_14black" align="center">
                            您的订单<span class="order_14red"><%=strOrderID%></span> 已经提交，您需要支付：<span class="order_14red"><%= decimal.Parse(strOrderAmount).ToString("0.00")%>元</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="order_14black" align="center">
                    ...
                    <tr>
                        <td>
                            <table width="40%" border="0" align="center" cellpadding="2" cellspacing="0">
                                <tr>
                                    <td>
                                        <img src="/images/web/kuaiqian.jpg" width="111" height="44" alt="" border="0" />
                                    </td>
                                    <td align="left">
