<%@ Page Language="c#" Codebehind="GetPayHandle.aspx.cs" AutoEventWireup="True" Inherits="Pbzx.Web.PortSampleForDotNet.GetPayHandle" %>
                ...
                <tr>
                    ...
                    <td width="970" align="center" bgcolor="#FFFFFF">
                        ...
                        <table width="85%" border="0" cellspacing="0" cellpadding="4">
                            ...
                            <tr>
                                ...
                                <td align="left" class="order_xia buy_okshuo">
                                    <font color="#000080">云网支付@网在线支付</font></td>
                                <td align="right" class="order_xia buy_okbiao">
                                    订单金额：</td>
                                <td align="left" class="order_xia buy_okshuo">
                                    <font color="#000080">
                        ...
                        <table width="85%" border="0" cellspacing="0" cellpadding="2">
                            <tr>
                                <td align="left">
                                    ...
                                    <%
                                        string strOrderType = Pbzx.Web.WebFunc.GetOrderType(c_order);
                                        if (strOrderType == "0")
                                        {
                                    %>
                        ...
                        <table width="85%" border="0" cellspacing="0" cellpadding="2">
                            <tr>
                                <td align="center">
                                    <a href="<%=orderDetailUrl %>" target="_blank">
                                        <img alt="查看" src="/Images/Web/see_register.jpg" border="0" /></a></td>
                            </tr>
                        </table>
                    </td>
