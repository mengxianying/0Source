<%@ Page Language="C#" AutoEventWireup="true" Inherits="Receive" Codebehind="Receive.aspx.cs" %>
...
<html>
<head>
    <title>网银在线支付结果 - 拼搏在线彩神通软件</title>
                ...
                <tr>
                    ...
                    <td width="970" align="center" bgcolor="#FFFFFF">
                        ...
                        <table width="85%" border="0" cellspacing="0" cellpadding="2">
                            <tr>
                                <td align="left">
                                    <b>注：</b>在支付完1-3分钟后，我们将收到您的支付信息；<br />
                                    <%
                                        string strOrderType = Pbzx.Web.WebFunc.GetOrderType(v_oid);
                                        if (strOrderType == "0")
                                        {
                                    %>
