...
{
    /// <summary>
    /// 实体类PBnet_SchoolType 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public class PBnet_SchoolType : IComparer<Pbzx.Model.PBnet_SchoolType>
    {
        ...
        #region IComparer<PBnet_SchoolType> 成员
        ...
        public int Compare(PBnet_SchoolType x, PBnet_SchoolType y)
        {
            if (IsDesc)
            {
