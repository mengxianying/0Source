...
{
	/// <summary>
	/// 实体类PBnet_NewsType 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
    public class PBnet_NewsType : IComparer<Pbzx.Model.PBnet_NewsType>
	{
        ...
        #region IComparer<PBnet_NewsType> 成员
        ...
        public int Compare(PBnet_NewsType x, PBnet_NewsType y)
        {
            if (IsDesc)
            {
