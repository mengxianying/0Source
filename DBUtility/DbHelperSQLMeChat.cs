...
namespace Maticsoft.DBUtility
{
    ...
    /// All rights reserved	
    /// </summary>
    public abstract class DbHelperSQLMeChat
    {

        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.
        private static string connectionString = ConfigurationManager.AppSettings["ConnectionStringMeChat"];

        public DbHelperSQLMeChat()
        {
        }
        ...
        public static int GetMaxID(string FieldName, string TableName)
        {
            ...
            object obj = DbHelperSQLMeChat.GetSingle(strsql);
            if (obj == null)
            {
                return 1;
            }
        ...
        {
            object obj = DbHelperSQLMeChat.GetSingle(strSql, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
