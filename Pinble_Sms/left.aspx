<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="left.aspx.cs" Inherits="Pinble_Sms.left" %>
...
<body>
    ...
    <div class="left">
        ...
        <div class="leftbar2">
            <ul>
                <li class="tab1"><span><a href="http://sms.pinble.com" target="_top" onclick="ShowOrHideMenu(this)"
                    leveloneid="level_one_6" name="menu_top" id="my_dxpt">短<br />
                    信<br />
                    平<br />
                    台</a></span></li>
                <li class="tab2"><span><a href="http://market.pinble.com" target="_top"  onclick="ShowOrHideMenu(this)" leveloneid="level_one_2"
    ...
    <div class="right">
        ...
        <div class="right2">
            ...
            <ul class="t_cz" id="level_one_6" style="display: block">
                <li>
                    <img src="../../Images/t_img_11.png" />
                    <ul class="tree">
                        <li>
