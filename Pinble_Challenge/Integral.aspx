<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Integral.aspx.cs" Inherits="Pinble_Challenge.Integral" %>
                ...
                <div class="yny_zhongj">
                    <div class="all">
                        <div class="tabtype" style="margin-top: 10px;">
                            <ul>
                                <li>
                                    <asp:LinkButton ID="lbtn_s" runat="server" PostBackUrl="~/Integral.aspx?id=s">双色球</asp:LinkButton>
                                </li>
                                <li>
                                    <asp:LinkButton ID="lbtn_d" runat="server" PostBackUrl="~/Integral.aspx?id=d">福彩3D</asp:LinkButton>
                                </li>
                                <li>
                                    <asp:LinkButton ID="lbtn_p" runat="server" PostBackUrl="~/Integral.aspx?id=p">排列三</asp:LinkButton>
                                </li>
                            </ul>
                        </div>
                        <div class="clear">
                        ...
                        <div class="ssq-expert-title">
                            ...
                            <div class="ssq-check" style="float: right; margin-right: 20px;">
                               <a href="IntegralStatistics.aspx" target="_blank">查看会员积分统计结果</a>
                                &nbsp; &nbsp; &nbsp; 
                                <asp:TextBox ID="txt_search" runat="server" style="border: 1px solid; height: 20px"></asp:TextBox> &nbsp; &nbsp;<asp:Button ID="Button3"
                                    runat="server" Text="搜索" class="seach-button" onclick="Button3_Click" />
                            </div>
                        </div>
                        <div id="content" runat="server">
                            <table class="ssq-expert-charts">
                                <asp:Repeater ID="rep_con" runat="server" OnItemDataBound="rep_con_ItemDataBound">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%# Eval("u_issue").ToString() == "" ? "---" : Eval("u_issue").ToString()%>
                                            </td>
                                            <td>
                                                <a href='Person.aspx?name=<%# Pbzx.Common.Input.URLEncode(Eval("u_name").ToString()) %>'
                                                    target="_blank">
                                                    <%# Eval("u_name")%></a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lab_lottType" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <%# Eval("u_coin")%>
                                            </td>
