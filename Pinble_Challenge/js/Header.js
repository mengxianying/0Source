        ...
        $(document).ready(function () {
            $.get("/reg.aspx", { IsLogin: "islogin" }, function (data) {
                if (data.split('&')[0] == "true") {
                    ...
                    //                    }
                    //                    $("#name").html("欢迎您：" + name.val() + "&nbsp;&nbsp登录拼搏擂台");
                    $("#name").html("欢迎您：<font color='red'><a href='/Person.aspx?name=" + escape(data.split('&')[1]) + "'>" + data.split('&')[1] + "</a></font>&nbsp;&nbsp登录拼搏擂台");
                    document.getElementById("logion").style.display = "none";
                    document.getElementById("linfo").style.display = "block";
                }
                else {
                    $("#aLoginOut").hide();
                    $("#spUser").hide();
                    ...
                    $.ajax({
                        ...
                        complete: function (msg, textStatus) {
                            ...
                            if (msg.responseText.split('&')[0] == "true") {
                                ...
                                $("#name").html("欢迎您：<font color='red'>" + name.val() + "</font>&nbsp;&nbsp登录拼搏擂台");
                                document.getElementById("logion").style.display = "none";
                                document.getElementById("linfo").style.display = "block";
                                location.reload();
                            }
            ...
            $("#aLoginOut").click(function () {
                $.get("/reg.aspx", { loginOut: "loginOut" }, function (data) {
                    if (data == "true") {
                        ...
                        document.getElementById("logion").style.display = "block";
