<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackNum.aspx.cs" Inherits="Pinble_Chipped.admin.TrackNum" %>
    ...
    <div>
         <asp:GridView ID="My_GridView" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="追号订单号">
                    <ItemTemplate>
                        <%# Eval("tn_order")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="已结/总期数">
                <ItemTemplate>
                    <asp:Label ID="lab_endNum" runat="server"></asp:Label>/<asp:Label ID="lab_totalNum" runat="server"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="详情">
                <ItemTemplate>
                    <a href='TrackNumList.aspx?orderNum=<%# Eval("tn_order") %>' target="mainFrame">详情</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
