<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transaction.aspx.cs" Inherits="Pinble_Chipped.admin.Transaction" %>
...
<body>
    ...
    <div style="margin-top: 10px; margin-bottom: 10px; text-align: center">
        <asp:GridView ID="My_GridView" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            ForeColor="#333333" PageSize="20" onrowdeleting="My_GridView_RowDeleting" 
            onrowediting="My_GridView_RowEditing">
