<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminBuyLogList.aspx.cs" Inherits="Pinble_Chipped.admin.AdminBuyLogList" %>
...
<body>
    ...
    <div class="header">
        ...
        <uc2:login ID="Login1" runat="server" />  </div>        <div class="nav">
                <dl class="b-top-nav">
                </dl>            </div>--%>
    </div>
    <!--header部分-->
