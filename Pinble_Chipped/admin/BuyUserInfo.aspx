<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyUserInfo.aspx.cs" Inherits="Pinble_Chipped.admin.BuyUserInfo" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="myGridView" runat="server" AutoGenerateColumns="False" CellPadding="4"
            GridLines="None" Width="99%" CssClass="rec_table" ForeColor="#333333" 
            EnableModelValidation="True" onrowcreated="myGridView_RowCreated1" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="购买的份数">
                <ItemTemplate>
                    <%# Eval("ChippedShare")%>
                </ItemTemplate>
                </asp:TemplateField>
