<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpectList.aspx.cs" Inherits="Pinble_Chipped.admin.ExpectList" %>
        ...
        <asp:GridView ID="My_GridView" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="注数">
                    <ItemTemplate>
                        <asp:Label ID="Rn_note" runat="server" Text=""></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="倍数">
                    <ItemTemplate>
                        <asp:Label ID="Rn_multiple" runat="server" Text=""></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="中止条件余额">
                    <ItemTemplate>
                        <asp:Label ID="Rn_tmtion" runat="server" Text=""></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="是否短信提示" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="Rn_mess" runat="server" Text=""></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="起止期数">
                    <ItemTemplate>
                         <asp:Label ID="Rn_begin" runat="server" Text=""></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="状态">
                    <ItemTemplate>
                        <asp:Label ID="Rn_state" runat="server" Text=""></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="已选期数">
                    <ItemTemplate>
                        <asp:Label ID="Rn_number" runat="server" Text=""></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="编辑">
                    <ItemTemplate>
                        <a href='ExpectDtl.aspx?rn_id=<%# Eval("Rn_id") %>&cpName=<%# Eval("Rn_play") %>'>详细</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
