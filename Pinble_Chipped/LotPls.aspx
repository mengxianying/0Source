<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotPls.aspx.cs" Inherits="Pinble_Chipped.LotPls" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript" charset="gb2312" src="js/Lotpls.js?date=new date().gettime()"></script>
    <script type="text/javascript" charset="gb2312" src="js/public.js?date=new date().gettime()"></script>
    <script type="text/javascript" src="js/NHandls.js?date=new date().gettime()"></script>
    <style type="text/css">
	/*选号球样式*/
.numberh {
	line-height:24px;
...
.login_info em{padding:0 11px;color:#ccc;}
                        ...
                        <!--多期机选开始部分-->
	<style type="text/css">
	.input1{width:35px; height:18px; color:#FF0000; font-weight:bold; border:1px solid #cccccc;}
	.sel_table{ border:1px #ccccc solid; width:100%;}
	.sel_table th{background:#f5f5f5; border-bottom:1px solid #ccc; padding-right:10px; border-right:1px #f3f3f3 solid;}
	.sel_table td{ border-bottom:1px solid #ccc; padding:12px; padding-left:20px;}
    ...
    <div id="doc3D" class="cp_3d">
        ...
        <div class="b-top">
            <div class="b-top-inner">
                ...
                <div class="b-top-info">
                    <a href="javascript:void 0" title="" class="on">第<%=Pbzx.BLL.publicMethod.Period("TCPL35Data")%>期</a><span>开奖时间：<%= Pbzx.BLL.publicMethod.lotteryNameData("TCPL35Data")%>
                        &nbsp;20:30 </span>
                </div>
                   <!--新增的用户信息部分-->
                ...
                <dl class="b-top-nav">
                    <dt><a href="javascript:ChangeColor('xuanhao')" title="" class="on" id="xuanhao">选号投注</a>
                        ...
                        <a href="javascript:ChangeColor('dingzhi_3D')" title="" class="" id="dingzhi" style="display: none">
                            定制跟单</a> <a href="javascript:ChangeColor('fanan_pls')" title="" class="" id="fangan">
                                我的方案</a> </dt>
                    <dd id="playTabsDd">
                        <div class="navchoose">
                            <div class="navchoose">
                ...
                <div class="b-top-tips">
                    ...
                    <div class="b-top-time">
                        截止时间： <span id="endtimeSpan">
                            <%= Pbzx.Common.Method.GetTCPL35DateTime.ToString()%>
                        ...
                        <script type="text/javascript">
                            function _fresh() {
                                //结束时间取配置文件中的数据                                    
                                var endtime = new Date("<%=Pbzx.Common.Method.GetTCPL35DateTime.ToString() %>".replace(/-/g, "/"));
        ...
        <div id="Large">
            ...
            <div id="J_mainav" class="cp-tab">
                ...
                <!------组选3------->
                <!------组选6------->
                <div id="zx6" class="cp-subnav" style="display: none">
                    <div class="tab-subcontent">
                        <div class="tab-pannel">
                            <!--直选-->
                            <label class="cp-typecheck">
                                <input class="J_zx6" name="c" type="radio" value="zx6p" checked="checked" />
                                 <span class="choose" id="Span5">普通</span></label>
                            <label class="cp-typecheck">
                                <input class="J_zx6" name="c" type="radio" value="zx6hz" />
                                 <span class="uchoose" id="Span6">和值</span></label>
                            <label class="cp-typecheck" style="display: none">
                                <input class="J_zx6" name="c" type="radio" value="zx6sc" />
                               <span class="uchoose" id="Span7">上传</span></label>
                            <label class="cp-typecheck" style="display:none">
                                <input class="J_zx6" name="c" type="radio" value="zx6sd" />
                              <span class="uchoose" id="Span8">手动输入</span></label>
                            <span class="cp-tip hidden" rel="提示说明文字">玩法提示</span>
                        </div>
                    </div>
                </div>
            ...
            <div id="hiddenT">
                ...
                <div id="touzhushow1" class="abacus  mode-2">
                                    ...
                                    <td>
                                        <div class="main">
                                            ...
                                            <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">0</span></div>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">1</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">2</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">3</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">4</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">5</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">6</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">7</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">8</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">9</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">10</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">11</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">12</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">13</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">14</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">15</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">16</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">17</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">18</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">19</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">20</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">21</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">22</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">23</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">24</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">25</span>
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">26</span>
                                                    <div id="zxhz2">
                                                <span class="number" id="hezhi_haoma" name="hezhi_haoma" style="cursor: pointer"
                                                    onclick="xuanhao(this);">27</span></div>
                    ...
                    <div id="zxxq">
                        ...
                        <div class="row clearfix" style="display: none" id="xhz6">
                            ...
                            <div class="main">
                                    <span class="number" id="zx6_haoma" name="zx6_haoma" style="cursor: pointer;
                                        display: none" onclick="xuanhao(this);">0</span>
                                    <span class="number" id="zx6_haoma" name="zx6_haoma" style="cursor: pointer;
                                        display: none" onclick="xuanhao(this);">1</span>
                                    <span class="number" id="zx6_haoma" name="zx6_haoma" style="cursor: pointer;
                                        display: none" onclick="xuanhao(this);">2</span>
                                    <span class="number" id="zx6_haoma" name="zx6_haoma" style="cursor: pointer"
                                        onclick="xuanhao(this);">3</span>
                                    <span class="number" id="zx6_haoma" name="zx6_haoma" style="cursor: pointer"
                                        onclick="xuanhao(this);">4</span>
                    ...
                    <div class="ft">
                        <p class="indicator">
                            ...
                            元 ]</p>
                        <p class="pr">
                            <a class="add-abacus" href="javascript:void(null);" onclick="Insert()"></a><a class="clear-all"
                                href="javascript:void(null)" onclick="clearall()"></a>
                        </p>
                    </div>
                    <!--* 投注容器 *-->
                        ...
                        <div id="dkm-groupBuy" class="dkm-pannel">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td class="td2">
                                        <em class="h">*</em>
                                        <input type="text" id="J_UnitedTitle" value="" class="plan-title txt" onKeyPress=checkLen(this) onKeyUp=checkLen(this) onChange=checkLen(this) />&nbsp;<span
                                            class="notice">您还可输入<span id="J_UnitedTitleLen">0</span>个字符，最多30个</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td1">
                                    ...
                                    <td class="td2 declar">
                                        <textarea id="mytext" cols="50" rows="5" class="plan-des" onkeydown="limitChars('mytext', 50)"
                                            onchange="limitChars('mytext', 50)" onpropertychange="limitChars('mytext', 50)"></textarea><span class="notice">您还可输入<span id="J_UnitedDescLen" class="str">0</span>个字符，最多50个</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td1">
                                    ...
                                    <td class="td2">
                                        ...
                                        %<em class="notice">(提成为1-10的整数，设置提成后至少认购与提成相等比例份额，无提成就选择0)</em>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td1">
                                    ...
                                    <td class="td2">
                                        ...
                                        份，<span class="notice">每份<span class="s4" id="lab_money"> <em class="fee">￥0</em> </span>元(每份至少0.2元，且必须能整除到分)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td1">
                                ...
                                <tr>
                                    ...
                                    <td class="td2">
                                        ...
                                        相对保密<em class="notice">(选号方案对未跟单人保密，开奖后公开)</em><br>
                                        <input type="radio" name="isSecret" id="J_Secret_2" value="2" />
                                        完全保密<em class="notice">(选号方案对所有人保密，开奖后公开)</em>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td1">
                ...
                <div class="confirm">
                    ...
                    <div class="cfm-btn">
                        ...
                        <script>
                              <%=Pbzx.Common.Method.IsLottory(Pbzx.Common.Method.GetTCPL35DateTime.ToString()) %>
                        </script>
                    </div>
                    <div class="cfm-document">
                        ...
                        <p class="item">
                            1、“排列三”是福彩中心发行的彩种。</p>
                        <p class="item">
                            2、根据福利彩票发行中心对“排列三”限号的规定，您所选择的某些投注单（包括追号）可能因限号无法投注，未成功投注单将作为失败订单处理。</p>
                        <p class="item">
                ...
                <div id="ft">
                    ...
                    <!-- 临时号码（为选号时准备） -->
                    <input type="hidden" name="lotId" id="playName" value="9999" />
                    <!-- 彩种ID（为提交投注准备）-->
                    <input type="hidden" name="playid" value="010" />
                    <!-- 玩法ID（为提交投注准备）-->
                    ...
                    <!-- 方案注数（为提交投注准备） -->
                    <input type="hidden" name="expect" id="ExpectNum" value="<%=Pbzx.BLL.publicMethod.Period("TCPL35Data")%>" />
                    <!-- 方案期号（为提交投注准备） -->
                    <input type="hidden" name="beishu" value="1" id="beishu" />
                    <!-- 方案倍数（为提交投注准备） -->
                    <input type="hidden" name="fileorcode" id="fileorcode" />
                    <input type="hidden" name="endtime" id="endtime" value="<%=Pbzx.Common.Method.GetTCPL35DateTime.ToString() %>" />
                    <!-- 号码（为提交投注准备） -->
                </div>
            </div>
        </div>
