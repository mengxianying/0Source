<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotDlt.aspx.cs" Inherits="Pinble_Chipped.LotDlt" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript" charset="gb2312" src="js/TLottery.js?date=new date().gettime()"></script>
            ...
            <div class="b-top">
                <div class="b-top-inner">
                    ...
                    <div class="b-top-info">
                        <a href="javascript:void(0)" title="" class="on">第<%=Pbzx.BLL.publicMethod.Period("TCDLTData")%>期</a><span>开奖时间：<%= Pbzx.BLL.publicMethod.lotteryNameData("TCDLTData")%>
                            &nbsp; 20:30 </span>
                    </div>
                    <!--新增的用户信息部分-->
                    ...
                    <dl class="b-top-nav">
                        <dt><a href="javascript:ChangeColor('xuanhao')" title="" class="on" id="xuanhao">选号投注</a>
                            ...
                            <a href="javascript:ChangeColor('dingzhi_dlt')" title="" class="" id="dingzhi" style="display: none">定制跟单</a>
                            <a href="javascript:ChangeColor('fanan_dlt')" title="" class="" id="fangan">我的方案</a>
                        </dt>
                        <dd id="playTabsDd">
                        </dd>
                    </dl>
                    <div class="b-top-tips">
                        ...
                        <div class="b-top-time">
                            截止时间： <span id="endtimeSpan">
                                <%=Pbzx.Common.Method.GetTCDLTDateTime.ToString()%>
                            </span>
                ...
                <div id="Large">
                    <div class="main-wrap">
                            ...
                            <div class="detail-info">
                                ...
                                <div id="J_SelectNumTab" class="cp-tab">
                                    <div class="cp-subnav">
                                        <div class="tab-subcontent">
                                            <div class="tab-pannel">
                                                <label>
                                                    <input class="J_SelectBuyMethod" name="a" type="radio" value="fs" checked="checked" /><span
                                    ...
                                    <div class="buy-box" id="fsy">
                                            ...
                                            <tr id="hmq">
                                                ...
                                                <td class="td1">
                                                    <p class="select-tips" id="J_RedSelectTips">
                                                        <span class="wrapper">[前区号码&nbsp;至少选择5个球 ]</span></p>
                                                </td>
                                                <td class="td2">
                                                    <p class="select-assist-tips">
                                                        <span class="blueWraper" id="J_BlueWeaper">[ 后区号码&nbsp;至少选择2个球]</span></p>
                                                </td>
                                            </tr>
                                            <tr class="ball-line J_BallLine" id="hmq1">
                                                ...
                                                <td class="td1">
                                                    <ul class="ball-list red J_BallList" id="J_RedRandHook">
                                                        ...
                                                        <li><span onclick="xuanhao(this,'h');" id="hongqiu" name="hongqiu" class="number"
                                                            style="cursor: pointer;">34</span></li>
                                                        <li><span onclick="xuanhao(this,'h');" id="hongqiu" name="hongqiu" class="number"
                                                            style="cursor: pointer;">35</span></li>
                                                    </ul>
                                                </td>
                                                <td class="td2">
                                            ...
                                            <tr id="hmq2">
                                                ...
                                                <td>
                                                    <div class="alignRight">
                                                        ...
                                                        <input type="button" class="jxRedBtn" id="J_JxRedBtn" value="机选前区" onclick="jxhq('h');" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="alignRight">
                                                        ...
                                                        <input type="button" class="jxBlueBtn" id="J_JxBlueBtn" value="机选后区" onclick="jxhq('l');" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <!-- End 复式 -->
                                        <!-------胆拖begin----------->
                                        <table class="J_BallArea ball-area" width="80%" border="0" cellspacing="0" cellpadding="0" style="display: none;"
                                            id="dty">
                                             <tr>
                                                <td class="td1" align="center" style="color:#ff9393; font-weight:bold;">
                                                    前区胆码(至少选择1个，最多4个)
                                                </td>
                                                <td class="td1" align="center" style="color:#ff9393; font-weight:bold;">
                                                    后区胆码（最多选1个）
                                            ...
                                            <tr class="ball-line J_BallLine">
                                                <td class="td4">
                                                    <ul class="ball-list red J_BallList" id="Ul1">
                                                        <li><span onclick="DTxuanhao(this,'h');" id="Qdama" name="Qdama" class="number" style="cursor: pointer;">
                                                            01</span></li>
                                                        <li><span onclick="DTxuanhao(this,'h');" id="Qdama" name="Qdama" class="number" style="cursor: pointer;">
                                                            02</span></li>
                                                        <li><span onclick="DTxuanhao(this,'h');" id="Qdama" name="Qdama" class="number" style="cursor: pointer;">
                                                ...
                                                <td class="td2">
                                                    <ul class="ball-list blue J_BallList">
                                                        <li><span onclick="DTxuanhao(this,'l');" id="Hdanma" name="Hdanma" class="number"
                                                            style="cursor: pointer;">01</span></li>
                                                        <li><span onclick="DTxuanhao(this,'l');" id="Hdanma" name="Hdanma" class="number"
                                                            style="cursor: pointer;">02</span></li>
                                                        <li><span onclick="DTxuanhao(this,'l');" id="Hdanma" name="Hdanma" class="number"
                                            ...
                                            <tr class="ball-line J_BallLine">
                                                <td class="td4">
                                                    <ul class="ball-list red J_BallList">
                                                        <li><span onclick="DTxuanhao(this,'h');" id="Qtuoma" name="Qtuoma" class="number"
                                                            style="cursor: pointer;">01</span></li>
                                                        <li><span onclick="DTxuanhao(this,'h');" id="Qtuoma" name="Qtuoma" class="number"
                                                            style="cursor: pointer;">02</span></li>
                                                        <li><span onclick="DTxuanhao(this,'h');" id="Qtuoma" name="Qtuoma" class="number"
                                                ...
                                                <td class="td2">
                                                    <ul class="ball-list blue J_BallList">
                                                        <li><span onclick="DTxuanhao(this,'l');" id="Htuoma" name="Htuoma" class="number"
                                                            style="cursor: pointer;">01</span></li>
                                                        <li><span onclick="DTxuanhao(this,'l');" id="Htuoma" name="Htuoma" class="number"
                                                            style="cursor: pointer;">02</span></li>
                                                        <li><span onclick="DTxuanhao(this,'l');" id="Htuoma" name="Htuoma" class="number"
                                            ...
                                            <tr>
                                                <td colspan="2" align="center">
                                                    <div class="select-count-tips">
                                                        <p class="wrapper">
                                                            [ <em id="J_PreDantuoSize">0</em> 个前区号码(<span id="J_PreDanSize">0</span>个胆码,<span
                                                                id="J_PreTuoSize">0</span>个拖码)，<em id="J_PreDantuoBlueSize">0</em> 个后区号码（<span id="J_AreaDanSize">0</span>个胆码,<span
                                                                    id="J_AreaTuoSize">0</span>个拖码），共 <em id="J_PreDantuoMulti">0</em> 注，金额
                        ...
                        <div class="more-operate" id="dis_mon">
                            ...
                            <p class="stake-count" id="P1">
                                <input id="ck_app" type="checkbox" /><em style="color: Red">追加投注</em>
                            </p>
                        ...
                        <!-- 临时号码（为选号时准备） -->
                        <input type="hidden" name="lotId" id="playName" value="6" />
                        <!-- 彩种ID（为提交投注准备）-->
                        <input type="hidden" name="playid" id="playid" value="6" />
                        <!-- 玩法ID（为提交投注准备） 大乐透为6-->
                        ...
                        <input type="hidden" name="beishu" value="1" id="beishu" />
                         <input type="hidden" name="endtime" id="endtime" value="<%=Pbzx.Common.Method.GetTCDLTDateTime.ToString() %>" />
                        <!-- 方案倍数（为提交投注准备） -->
                        ...
                        <div class="confirm" id="betting">
                            ...
                            <script>
                                var ltime = '<%=Pbzx.Common.Method.GetTCDLTDateTime.ToString() %>';
                                var btime = '<%=DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") %>';
                                if (ltime > btime) {
                                    $("#J_SubmitPay").attr("style", "background: url(/images/norepeat_bg.png) no-repeat 0px -470px");

                                } else {
                                    $("#J_SubmitPay").attr("disabled", "disabled");
                                    $("#J_SubmitPay").attr("style", "background: url(/images/norepeat_bg.png) no-repeat 0px -620px");
                                }
                            </script>
                        </div>
                        <!-----投注区------->
                    ...
                    <!--当前期号--->
                    <input id="preid" type="hidden" value='<%=Pbzx.BLL.publicMethod.Period("TCDLTData")%>' />
                    <!------当前购买金额------->
                    <input id="curr_money" type="hidden" />
                    <input id="playState" type="hidden" value="6" />
                </div>
                <%--合买方案begin--%>
