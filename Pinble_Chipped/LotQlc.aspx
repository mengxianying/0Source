<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotQlc.aspx.cs" Inherits="Pinble_Chipped.LotQlc" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript" charset="gb2312" src="js/qlc.js?date=new date().gettime()"></script>
            ...
            <div class="b-top">
                <div class="b-top-inner">
                    ...
                    <div class="b-top-info">
                        <a href="javascript:void(0)" title="" class="on">第<%=Pbzx.BLL.publicMethod.Period("FC7LC") %>期</a><span>开奖时间：<%= Pbzx.BLL.publicMethod.lotteryNameData("FC7LC")%>
                            &nbsp;21:30 </span>
                    </div>
                    <!--新增的用户信息部分-->
                    ...
                    <dl class="b-top-nav">
                        <dt><a href="javascript:ChangeColor('xuanhao')" title="" class="on" id="xuanhao">选号投注</a>
                            <a href="javascript:void(0)" title="" class="" id="canyu" onclick="ChangeColor('canyu')">
                                参与合买</a> <a href="javascript:ChangeColor('dingzhi_qlc')" title="" class="" id="dingzhi" style="display: none">
                                    定制跟单</a> <a href="javascript:ChangeColor('fanan_qlc')" title="" class="" id="fangan">
                                        我的方案</a> </dt>
                        <dd id="playTabsDd">
                            <a href="#" title="" class="on"><em>自助选号</em></a></dd>
                    </dl>
                    <div class="b-top-tips">
                        ...
                        <div class="b-top-time">
                            截止时间： <span id="endtimeSpan"></span>
                            <%=Pbzx.Common.Method.GetFC7LCDateTime.ToString()%>
                            <span id="countDownSpan">还剩 <span id="_lefttime" style="color: Red"></span></span>
                            <script type="text/javascript">
                                function _fresh() {
                                    //结束时间取配置文件中的数据                                    
                                    var endtime = new Date("<%=Pbzx.Common.Method.GetFC7LCDateTime.ToString() %>".replace(/-/g, "/"));
            ...
            <div class="col-main">
                <div id="Large">
                    <div class="main-wrap">
                                        ...
                                        <div class="tab-subcontent">
                                            <div class="tab-pannel">
                                                <label class="cp-typecheck">
                                                    <input class="J_SelectBuyMethod" name="a" type="radio" value="pt" checked="checked" /><span
                                                        id="ssq_fs" class="choose">普通</span></label>
                                                <label class="cp-typecheck">
                                                    <input class="J_SelectBuyMethod" name="a" type="radio" value="dt" />
                                                    <span id="ssq_dt" class="uchoose">胆拖</span></label>
                                                <label style="display: none" class="cp-typecheck">
                                                    <input class="J_SelectBuyMethod" name="a" type="radio" value="sc" /><span id="ssq_sc"
                                                        class="uchoose">上传</span></label>
                                                <label class="cp-typecheck">
                                                    <input class="J_SelectBuyMethod" name="a" type="radio" value="sd" /><span id="ssq_sd"
                                                        class="uchoose">手动输入</span></label>
                                                <label class="cp-typecheck">
                                                    <input class="J_SelectBuyMethod" name="a" type="radio" value="dqxh" /><span id="ssq_dqxh"
                                                        class="uchoose">多期机选</span></label>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- start 复式 -->
                                    <div class="buy-box" id="fsy">
                                        <table class="J_BallArea ball-area" border="0" width="80%" cellspacing="0" cellpadding="0"
                                            id="fsTab">
                                            <tr id="hmq">
                                                <th class="th1">
                                                    &nbsp;
                                                ...
                                                <td class="td3">
                                                    <p class="select-tips" id="J_RedSelectTips">
                                                        <span class="wrapper">[至少选择7个球 ]</span></p>
                                                </td>
                                            </tr>
                                            <tr class="ball-line J_BallLine" id="hmq1">
                                                <th class="th1" width="10%" style="padding-left: 10px;">
                                                    <em class="txt-select">选择号码</em>&nbsp;
                                                </th>
                                                <td class="td3">
                                            ...
                                            <tr id="hmq2">
                                                ...
                                                <td>
                                                    <div class="alignRight">
                                                        ...
                                                        <input type="button" class="jxRedBtn" id="J_JxRedBtn" value="机选号码" onclick="jxhq('h');" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <div id="sdsrh" style="width: 100%; margin-left: 20px; display: none">
                                                        <div>
                                                            <asp:TextBox ID="tb_ManualInput" runat="server" Height="135px" TextMode="MultiLine"
                                                                Style="width: 480px; height: 150px; float: left; margin-right: 30px;" onkeyup="Show();"></asp:TextBox>
                                                            <%--<textarea id="tb_ManualInput" cols="20" rows="2" style="width: 480px; height: 150px;
                                                                float: left; margin-right: 30px;" onkeyup="Show();"></textarea>--%>
                                        ...
                                        <!-----------胆拖begin--------------->
                                        <table class="J_BallArea ball-area" border="0" width="80%" cellspacing="0" cellpadding="0"
                                            style="display: none;" id="dty">
                                            <tr>
                                                <th class="th1">
                                                    &nbsp;
                                                </th>
                                                <td class="td1">
                                                    <p class="select-tips" id="P1">
                                                        <span class="wrapper">胆码区（我认为必出的胆码-最多选择6个胆码）</span></p>
                                                </td>
                                                <td class="td1">
                                                    <p class="select-tips" id="P2">
                                                        <span class="wrapper">拖码区（我认为可能出的拖码）</span></p>
                                                </td>
                                            </tr>
                                            <tr class="ball-line J_BallLine">
                                                ...
                                                <td class="td1">
                                                    <ul class="ball-list red J_BallList" id="Ul1">
                                                        <li><span onclick="DTxuanhao(this,'h');" id="danma" name="danma" class="number" style="cursor: pointer;">
                                                            01</span></li>
                                                        <li><span onclick="DTxuanhao(this,'h');" id="danma" name="danma" class="number" style="cursor: pointer;">
                                                            02</span></li>
                                                        <li><span onclick="DTxuanhao(this,'h');" id="danma" name="danma" class="number" style="cursor: pointer;">
                                                ...
                                                <td class="td1">
                                                    <ul class="ball-list red J_BallList" id="Ul2">
                                                        <li><span onclick="DTxuanhao(this,'h');" id="tuoma" name="tuoma" class="number" style="cursor: pointer;">
                                                            01</span></li>
                                                        <li><span onclick="DTxuanhao(this,'h');" id="tuoma" name="tuoma" class="number" style="cursor: pointer;">
                                                            02</span></li>
                                                        <li><span onclick="DTxuanhao(this,'h');" id="tuoma" name="tuoma" class="number" style="cursor: pointer;">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <div class="select-count-tips" align="center">
                                                        <p class="wrapper">
                                                            [ 您一共选择了 <em id="EmNum">0</em> 注，共 <em class="money" id="EmMoney">0</em> 元 ]</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <!--选号列表&操作选号列表-->
                                        <div class="num-list">
                                            <select name="schemeNum" id="schemeNum" size="10" class="select-list" style="height: 132px">
                                            </select>
                                            <ul class="liebiao">
                                                <li class="random-one"><a href="javascript:void(null);" onclick="jixuan_1(1)">机选1注</a></li>
                                                <li class="random-five"><a href="javascript:void(null);" onclick="jixuan_1(6)">机选6注</a></li>
                                                <li class="random-one"><a href="javascript:void(null);" onclick="jixuan_1(2)">机选2注</a></li>
                                                <li class="random-five"><a href="javascript:void(null);" onclick="jixuan_1(8)">机选8注</a></li>
                                                <li class="random-one"><a href="javascript:void(null);" onclick="jixuan_1(4)">机选4注</a></li>
                                                <li class="random-five"><a href="javascript:void(null);" onclick="jixuan_1(10)">机选10注</a></li>
                        ...
                        <!-- 临时号码（为选号时准备） -->
                        <input type="hidden" name="lotId" id="playName" value="2" />
                        <!-- 彩种ID（为提交投注准备）-->
                        <input type="hidden" name="playid" id="playid" value="2" />
                        <!-- 玩法ID（为提交投注准备） 七乐彩2-->
                        ...
                        <input type="hidden" name="endtime" id="endtime" value="<%=Pbzx.Common.Method.GetFC7LCDateTime.ToString() %>" />
                        <!-- 号码（为提交投注准备） -->
                        <!--彩种截止时间--->
                        <div class="confirm" id="betting">
                            ...
                            <script>
                                <%=Pbzx.Common.Method.IsLottory(Pbzx.Common.Method.GetFC7LCDateTime.ToString()) %>
                            </script>
                        </div>
                    </div>
                    <%--多期选号--%>
                    ...
                    <!--当前期号--->
                    <input id="preid" type="hidden" value='<%=Pbzx.BLL.publicMethod.Period("FC7LC")%>' />
                    <!------当前购买金额------->
                    <input id="curr_money" type="hidden" />
                    <input id="playState" type="hidden" value="2" />
                </div>
                <%--合买方案begin--%>
