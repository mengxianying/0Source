<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotQxc.aspx.cs" Inherits="Pinble_Chipped.LotQxc" %>
...
<head>
    ...
    <script type="text/javascript" src="js/Handls.js?date=new date().gettime()"></script>
    <script type="text/javascript" charset="gb2312" src="js/public.js?date=new date().gettime()"></script>
    <script language="javascript" type="text/javascript" charset="gb2312" src="js/qxcJS.js?date=new date().gettime()"></script>
    <style type="text/css">
	/*选号球样式*/
.numberh {
	line-height:24px;
    ...
    <div id="doc3D" class="cp_3d">
        ...
        <div class="b-top">
            <div class="b-top-inner">
                ...
                <div class="b-top-info">
                    <a href="javascript:void(0)" title="" class="on">第<%=Pbzx.BLL.publicMethod.Period("TC7XCData")%>期</a><span>开奖时间：<%= Pbzx.BLL.publicMethod.lotteryNameData("TC7XCData")%>
                        &nbsp; 20:30 </span>
                </div>
                ...
                <dl class="b-top-nav">
                    <dt><a href="javascript:ChangeColor('xuanhao')" title="" class="on" id="xuanhao">选号投注</a>
                        ...
                        <a href="javascript:ChangeColor('dingzhi')" title="" class="" id="dingzhi" style="display: none">
                            定制跟单</a> <a href="javascript:ChangeColor('fanan_qxc')" title="" class="" id="fangan">
                                我的方案</a> </dt>
                    <dd id="playTabsDd">
                    </dd>
                </dl>
                <div class="b-top-tips">
                    ...
                    <div class="b-top-time">
                        截止时间： <span id="endtimeSpan">
                            <%= Pbzx.Common.Method.GetTC7XCDateTime.ToString()%>
                        ...
                        <script type="text/javascript">
                            function _fresh() {
                                //结束时间取配置文件中的数据                                    
                                var endtime = new Date("<%=Pbzx.Common.Method.GetTC7XCDateTime.ToString() %>".replace(/-/g, "/"));
        ...
        <div id="Large">
            ...
            <div id="hiddenT">
                ...
                <div id="touzhushow1" class="abacus  mode-2">
                    <div class="uploadTips">
                        玩法提示：从0000000~9999999选择任意7个自然数进行投注</div>
                    ...
                    <div class="bd">
                        ...
                        <div id="xuanqiu">
                            <table width="90%" border="0" cellspacing="10" cellpadding="0">
                                ...
                                <tr>
                                    <td>
                                        <div class="indicate">
                                            <span class="cp-digit">第四位</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            <span class="number" id="three_haoma4" name="three_haoma4" style="cursor: pointer"
                                                onclick="xuanhao(this);">0</span> <span class="number" id="three_haoma4" name="three_haoma4"
                                                    style="cursor: pointer" onclick="xuanhao(this);">1</span> <span class="number" id="three_haoma4"
                                                        name="three_haoma4" style="cursor: pointer" onclick="xuanhao(this);">2</span>
                                            <span class="number" id="three_haoma4" name="three_haoma4" style="cursor: pointer"
                                                onclick="xuanhao(this);">3</span> <span class="number" id="three_haoma4" name="three_haoma4"
                                                    style="cursor: pointer" onclick="xuanhao(this);">4</span> <span class="number" id="three_haoma4"
                                                        name="three_haoma4" style="cursor: pointer" onclick="xuanhao(this);">5</span>
                                            <span class="number" id="three_haoma4" name="three_haoma4" style="cursor: pointer"
                                                onclick="xuanhao(this);">6</span> <span class="number" id="three_haoma4" name="three_haoma4"
                                                    style="cursor: pointer" onclick="xuanhao(this);">7</span> <span class="number" id="three_haoma4"
                                                        name="three_haoma4" style="cursor: pointer" onclick="xuanhao(this);">8</span>
                                            <span class="number" id="three_haoma4" name="three_haoma4" style="cursor: pointer"
                                                onclick="xuanhao(this);">9</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="help">
                                            <a class="cp-op all" href="javascript:selectcode(4,'selall');">全</a> <a class="cp-op big"
                                                href="javascript:selectcode(4,'selda');">大</a> <a class="cp-op small" href="javascript:selectcode(4,'selxiao');">
                                                    小</a> <a class="cp-op odd" href="javascript:selectcode(4,'seljin');">奇</a>
                                            <a class="cp-op even" href="javascript:selectcode(4,'selou');">偶</a> <a class="cp-op clear"
                                                href="javascript:selectcode(4,'delall');">清除</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="indicate">
                                            <span class="cp-digit">第六位</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            <span class="number" id="three_haoma6" name="three_haoma6" style="cursor: pointer"
                                                onclick="xuanhao(this);">0</span> <span class="number" id="three_haoma6" name="three_haoma6"
                                                    style="cursor: pointer" onclick="xuanhao(this);">1</span> <span class="number" id="three_haoma6"
                                                        name="three_haoma6" style="cursor: pointer" onclick="xuanhao(this);">2</span>
                                            <span class="number" id="three_haoma6" name="three_haoma6" style="cursor: pointer"
                                                onclick="xuanhao(this);">3</span> <span class="number" id="three_haoma6" name="three_haoma6"
                                                    style="cursor: pointer" onclick="xuanhao(this);">4</span> <span class="number" id="three_haoma6"
                                                        name="three_haoma6" style="cursor: pointer" onclick="xuanhao(this);">5</span>
                                            <span class="number" id="three_haoma6" name="three_haoma6" style="cursor: pointer"
                                                onclick="xuanhao(this);">6</span> <span class="number" id="three_haoma6" name="three_haoma6"
                                                    style="cursor: pointer" onclick="xuanhao(this);">7</span> <span class="number" id="three_haoma6"
                                                        name="three_haoma6" style="cursor: pointer" onclick="xuanhao(this);">8</span>
                                            <span class="number" id="three_haoma6" name="three_haoma6" style="cursor: pointer"
                                                onclick="xuanhao(this);">9</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="help">
                                            <a class="cp-op all" href="javascript:selectcode(6,'selall');">全</a> <a class="cp-op big"
                                                href="javascript:selectcode(6,'selda');">大</a> <a class="cp-op small" href="javascript:selectcode(6,'selxiao');">
                                                    小</a> <a class="cp-op odd" href="javascript:selectcode(6,'seljin');">奇</a>
                                            <a class="cp-op even" href="javascript:selectcode(6,'selou');">偶</a> <a class="cp-op clear"
                                                href="javascript:selectcode(6,'delall');">清除</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="indicate">
                                            <span class="cp-digit">第七位</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            <span class="number" id="three_haoma7" name="three_haoma7" style="cursor: pointer"
                                                onclick="xuanhao(this);">0</span> <span class="number" id="three_haoma7" name="three_haoma7"
                                                    style="cursor: pointer" onclick="xuanhao(this);">1</span> <span class="number" id="three_haoma7"
                                                        name="three_haoma7" style="cursor: pointer" onclick="xuanhao(this);">2</span>
                                            <span class="number" id="three_haoma7" name="three_haoma7" style="cursor: pointer"
                                                onclick="xuanhao(this);">3</span> <span class="number" id="three_haoma7" name="three_haoma7"
                                                    style="cursor: pointer" onclick="xuanhao(this);">4</span> <span class="number" id="three_haoma7"
                                                        name="three_haoma7" style="cursor: pointer" onclick="xuanhao(this);">5</span>
                                            <span class="number" id="three_haoma7" name="three_haoma7" style="cursor: pointer"
                                                onclick="xuanhao(this);">6</span> <span class="number" id="three_haoma7" name="three_haoma7"
                                                    style="cursor: pointer" onclick="xuanhao(this);">7</span> <span class="number" id="three_haoma7"
                                                        name="three_haoma7" style="cursor: pointer" onclick="xuanhao(this);">8</span>
                                            <span class="number" id="three_haoma7" name="three_haoma7" style="cursor: pointer"
                                                onclick="xuanhao(this);">9</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="help">
                                            <a class="cp-op all" href="javascript:selectcode(7,'selall');">全</a> <a class="cp-op big"
                                                href="javascript:selectcode(7,'selda');">大</a> <a class="cp-op small" href="javascript:selectcode(7,'selxiao');">
                                                    小</a> <a class="cp-op odd" href="javascript:selectcode(7,'seljin');">奇</a>
                                            <a class="cp-op even" href="javascript:selectcode(7,'selou');">偶</a> <a class="cp-op clear"
                                                href="javascript:selectcode(7,'delall');">清除</a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div id="sdsrh" style="width: 100%; margin-left: 20px; display: none">
                            <textarea id="tb_ManualInput" cols="20" rows="2" style="width: 650px; height: 150px;
                            ...
                            <span class="bigfont">1、把号码写入左边文本框内；<br />
                                2、从彩神通软件编辑器内复制所要投注的号码到左边文本框内；<br />
                                3、从你的文档中直接复制所要投注的号码到左边文本框内；<br />
                                4、从其他网页复制所要投注的号码到左边文本框内。<br />
                                <br />
                            </span>
                        </div>
                    </div>
                ...
                <div class="num-list" style="margin-left: 50px;" id="J_Basket">
                    <select name="schemeNum" size="5" id="schemeNum" class="select-list" style="height: 132px">
                    </select>
                    <ul class="liebiao">
                        <li class="random-one"><a href="javascript:void(null);" onclick="jixuan(1)">机选1注</a></li>
                        <li class="random-one"><a href="javascript:void(null);" onclick="jixuan(5)">机选5注</a></li>
                        <li class="random-one"><a href="javascript:void(null);" onclick="jixuan(10)">机选10注</a></li>
            ...
            <div class="donkeyman">
                    ...
                    <span class="dkm-bt">倍投：<input type="text" size="5" class="red" name="setbeishu"
                        ...
                        value="1" />倍(最大<em>99</em>倍)</span>&nbsp; <span class="dkm-zhs">注数：<em id="showdanbeizhushu">0</em>
                            注</span> 倍数：<span class="dkm-zhs" id="showbeishu">1</span>倍 <span class="dkm-je">金额：<em
                                class="h" id="showallmoney">￥0</em> 元 </span>
                    <!--发起合买checkbox-->
                ...
                <!------追号显示期号部分------>
                <div class="united-buy-plan" id="chipped" style="display: none">
                    <!--发起合买开始-->
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="td2">
                                    ...
                                    份，每份<span class="s4" id="lab_money"> <em class="fee">￥0</em> 元</span>(每份至少0.2元，且必须能整除到分)
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">
            ...
            <div class="confirm">
                <div class="cfm-info">
                    <div class="cfm-docshow">
                        <input type="checkbox" name="" id="Checkbox2" checked="checked" />
                        <span class="vm">我已阅读了<a href="Agreement.aspx" target="_blank">《用户合买代购协议》</a>并同意其中条款</span>
                    </div>
                </div>
                <div class="cfm-btn">
                    ...
                    <script>
                              <%=Pbzx.Common.Method.IsLottory(Pbzx.Common.Method.GetTC7XCDateTime.ToString()) %>
                    </script>
                </div>
            </div>
            <div id="ft">
                ...
                <!-- 临时号码（为选号时准备） -->
                <input type="hidden" name="lotId" id="playName" value="5" />
                <!-- 彩种ID（为提交投注准备）-->
                <input type="hidden" name="playid" value="5" />
                <!-- 玩法ID（为提交投注准备）-->
                ...
                <!-- 方案注数（为提交投注准备） -->
                <input type="hidden" name="expect" id="ExpectNum" value='<%=Pbzx.BLL.publicMethod.Period("TC7XCData")%>' />
                <!-- 方案期号（为提交投注准备） -->
                <input type="hidden" name="beishu" value="1" id="beishu" />
                <input type="hidden" name="endtime" id="endtime" value="<%=Pbzx.Common.Method.GetTC7XCDateTime.ToString() %>" />
                <!-- 方案倍数（为提交投注准备） -->
                ...
                <div class="c-wrap">
                    <div class="c-inner">
                        <div class="an_title p-l0">
                            ...
                            <%-- <span>置顶规则<s class="i-qw"></s> <a href="#" title="" style="cursor: default; text-decoration: none">
                                    查看</a>
                                    <select id="periodSelection" name="periodSelection" onchange="do_search(3,'')">
                                        <option value="11049|2011-02-25 19:40:00|2" style="color: red">11049 当前期</option>
