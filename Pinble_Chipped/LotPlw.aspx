<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotPlw.aspx.cs" Inherits="Pinble_Chipped.LotPlw" %>
...
<head>
    ...
    <script type="text/javascript" charset="gb2312" src="js/plw.js?date=new date().gettime()"></script>
        ...
        <div class="b-top">
            <div class="b-top-inner">
                ...
                <div class="b-top-info">
                    <a href="javascript:void 0" title="" class="on">当前第<%=Pbzx.BLL.publicMethod.Period("TCPL35Data")%>期</a><span>开奖时间：<%= Pbzx.BLL.publicMethod.lotteryNameData("TCPL35Data")%>&nbsp;
                        20:30 </span>
                </div>
                <!--新增的用户信息部分-->
                ...
                <dl class="b-top-nav">
                    <dt><a href="javascript:ChangeColor('xuanhao')" title="" class="on" id="xuanhao">选号投注</a>
                        ...
                        <a href="javascript:ChangeColor('dingzhi')" title="" class="" id="dingzhi" style="display: none">
                            定制跟单</a> <a href="javascript:ChangeColor('fanan_plw')" title="" class="" id="fangan">
                                我的方案</a> </dt>
                    <dd id="playTabsDd">
                        <%--<input type="radio" name="Buytype" id="Buytype" value="zx" checked="checked" onclick="fangshi();" />直选--%>
                    </dd>
                </dl>
        ...
        <div id="Large">
            ...
            <div id="hiddenT">
                ...
                <div id="touzhushow1" class="abacus  mode-2">
                    <div class="uploadTips" id="PromptTit">
                        玩法提示：从00000-99999中的数字中选出5位数投注，若与中奖号码全部相同且顺序一致，奖金100000。
                    </div>
                    <div class="hd">
                        <!--提示语区-->
                    ...
                    <div class="bd">
                        ...
                        <div id="sdsrh" style="width: 100%; margin-left: 20px; display: none">
                            <%--<textarea id="tb_ManualInput" cols="20" rows="2" style="width: 480px; height: 150px; float:left; margin-right:30px;" onkeyup="DisNum();"></textarea>
                               		 <div style="font-size:14px; color:#FF0000; font-weight:bold;">号码输入方式：<br /></div>
									 <span class="bigfont"> 
										   1、把号码写入左边文本框内；<br />
                                ...
                                <tr>
                                    ...
                                    <td class="td2">
                                        ...
                                        <input size="5" id="txt_pcopy" class="txt1 buynum" type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'');InsertShow();"
                                            onbeforepaste="BeforePaste();" value="1" />
                                        份 共计<span class="money" id="money">0</span>元<span class="notice"> (至少要认购<span class="s1"
                                            id="J_UniteBuyMinSubscribeCent">1</span>份)
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td1">
                ...
                <div id="ft">
                    ...
                    <!-- 临时号码（为选号时准备） -->
                    <input type="hidden" name="lotId" id="playName" value="4" />
                    <!-- 彩种ID（为提交投注准备）-->
                    <input type="hidden" name="playid" value="4" />
                    <!-- 玩法ID（为提交投注准备）-->
