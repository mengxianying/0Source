...
;(function(){
	$.XYTipsWindow=function(o){
		defaults = $.extend({
			...
			___boxID: "XYTipsWindow"+parseInt(Math.random()*1000),
			___content: "text:内容",
			___width: "300",
			___height: "200",
	...
	$.extend($.XYTipsWindow,{
		...
		showBox: function(o) {
			...
			var $boxDom = "<div id=\""+o.___boxID+"\" class=\"XYTipsWindow\">";
				...
				$boxDom += "<div class=\"___boxTitle\"><h3></h3><span>关闭</span></div>";
			...
			if (isIE6){
				if (o.___triggerID=="") {
					if (TOP>=0){
						$wrap=$("<div class=\"IE6FIXED\" id=\""+o.___boxID+"parent\" style=\"top:expression(documentElement.scrollTop+"+TOP+");\"></div>");
					}else{
						$wrap=$("<div class=\"IE6FIXED\" id=\""+o.___boxID+"parent\" style=\"top:expression(documentElement.scrollTop+documentElement.clientHeight-this.offsetHeight);\"></div>");
					};
					$("body").append($wrap);
