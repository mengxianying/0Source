...
{
    public partial class downloadNum : System.Web.UI.Page
    {
        ...
        public void BindGridView1()
        {
            ...
            int mycount = 0;
            IsResult = get_dd.GuestGetBySearchdownD(Searchstr, "*", order, 50, 3, AspNetPager1.CurrentPageIndex, out mycount);
            this.GridView1.DataSource = IsResult;
            this.GridView1.DataKeyNames = new string[] { "Dl_id" };
        ...
        {
            if (get_dd.Delete(Convert.ToInt32(this.GridView1.DataKeys[e.RowIndex].Value))>0)
            {
        ...
        protected void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                if (cb.Checked == true)
                {
                    ...
                    n_state = get_dd.Delete(Convert.ToInt32(GridView1.DataKeys[i].Value));
                }
            }
            if (n_state>0)
            {
