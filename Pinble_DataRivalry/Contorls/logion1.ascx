<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="logion1.ascx.cs" Inherits="Pinble_DataRivalry.Contorls.logion1" %>
...
<div class="zanneiy_red">
    ...
    <div id="linfo" style="display: none">
     <ul class="yleft">
           ...
           <li> <a href="../RelUpload.aspx" target="_blank">发布大底</a></li> 
