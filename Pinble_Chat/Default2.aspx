<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default2.aspx.cs" Inherits="Pinble_Chat.Default2" %>
...
<%@ Register src="Contorls/Head_ChatHav.ascx" tagname="Head_ChatHav" tagprefix="uc2" %>
...
<body>
    ...
    <div style="text-align: center;">
        <uc2:Head_ChatHav ID="Head_ChatHav1" runat="server" />
            <div class="bodyw MT">
                <!--左边--->
