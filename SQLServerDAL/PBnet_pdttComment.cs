...
{
	/// <summary>
	/// 数据访问类PBnet_pdttComment。
	/// </summary>
	public class PBnet_pdttComment:IPBnet_pdttComment
	{
		public PBnet_pdttComment()
		{}
		#region  成员方法
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("pb_CommentID", "PBnet_pdttComment"); 
		}
		...
		public bool Exists(int pb_CommentID)
		{
			...
			strSql.Append("select count(1) from PBnet_pdttComment");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Pbzx.Model.PBnet_pdttComment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into PBnet_pdttComment(");
		...
		/// 更新一条数据
		/// </summary>
		public void Update(Pbzx.Model.PBnet_pdttComment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update PBnet_pdttComment set ");
		...
		public void Delete(int pb_CommentID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete PBnet_pdttComment ");
			strSql.Append(" where pb_CommentID=@pb_CommentID ");
			SqlParameter[] parameters = {
					new SqlParameter("@pb_CommentID", SqlDbType.Int,4)};
			parameters[0].Value = pb_CommentID;
		...
		/// 得到一个对象实体
		/// </summary>
		public Pbzx.Model.PBnet_pdttComment GetModel(int pb_CommentID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 pb_CommentID,pb_ClassID,pb_SoftID,pb_UserType,pb_UserName,pb_Sex,pb_qq,pb_Msn,pb_Email,pb_Homepage,pb_IP,pb_WriteTime,pb_Score,pb_Content,pb_ReplyName,pb_ReplyContent,pb_ReplyTime from PBnet_pdttComment ");
			strSql.Append(" where pb_CommentID=@pb_CommentID ");
			SqlParameter[] parameters = {
					new SqlParameter("@pb_CommentID", SqlDbType.Int,4)};
			parameters[0].Value = pb_CommentID;

			Pbzx.Model.PBnet_pdttComment model=new Pbzx.Model.PBnet_pdttComment();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM PBnet_pdttComment ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "PBnet_pdttComment";
