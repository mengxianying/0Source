...
namespace Pbzx.SQLServerDAL
{
    ...
    /// 数据访问类PBnet_NewsType。
    /// </summary>
    public class PBnet_NewsType : IPBnet_NewsType
    {
        ...
        public bool Exists(int IntNewsTypeID)
        {
            ...
            strSql.Append("select count(1) from PBnet_NewsType");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.PBnet_NewsType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into PBnet_NewsType(");
        ...
        /// 更新一条数据
        /// </summary>
        public int  Update(Pbzx.Model.PBnet_NewsType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update PBnet_NewsType set ");
        ...
        public int  Delete(int IntNewsTypeID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from PBnet_NewsType ");
            strSql.Append(" where IntNewsTypeID=@IntNewsTypeID ");
            SqlParameter[] parameters = {
					new SqlParameter("@IntNewsTypeID", SqlDbType.Int,4)};
            parameters[0].Value = IntNewsTypeID;
        ...
        public Pbzx.Model.PBnet_NewsType GetModel(int IntNewsTypeID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 IntNewsTypeID,VarTypeName,IntTypeFID,IntTypeLevel,BitComment,BitIsAuditing,IntOrderID,Depth,RootID,ModuleFIDS,TypeEnName,DisCount,IntSortID from PBnet_NewsType ");
            strSql.Append(" where IntNewsTypeID=@IntNewsTypeID ");
            SqlParameter[] parameters = {
					new SqlParameter("@IntNewsTypeID", SqlDbType.Int,4)};
            parameters[0].Value = IntNewsTypeID;

            Pbzx.Model.PBnet_NewsType model = new Pbzx.Model.PBnet_NewsType();
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "PBnet_NewsType";
