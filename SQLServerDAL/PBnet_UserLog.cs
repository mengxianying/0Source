...
namespace Pbzx.SQLServerDAL
{
    ...
    /// 数据访问类PBnet_UserLog。
    /// </summary>
    public class PBnet_UserLog : IPBnet_UserLog
    {
        ...
        public bool Exists(long id)
        {
            ...
            strSql.Append("select count(1) from PBnet_UserLog");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into PBnet_UserLog(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update PBnet_UserLog set ");
        ...
        public void Delete(long id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from PBnet_UserLog ");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
            parameters[0].Value = id;
        ...
        public Pbzx.Model.PBnet_UserLog GetModel(long id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,log_username,log_password,log_time,log_Ip,log_state,log_stepinto,log_urlname,log_allhttp,log_country,log_city from PBnet_UserLog ");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
            parameters[0].Value = id;

            Pbzx.Model.PBnet_UserLog model = new Pbzx.Model.PBnet_UserLog();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM PBnet_UserLog ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "PBnet_UserLog";
