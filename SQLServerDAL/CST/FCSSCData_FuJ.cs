...
namespace Pbzx.SQLServerDAL
{
    ...
    /// 数据访问类FCSSCData_FuJ。
    /// </summary>
    public class FCSSCData_FuJ : IFCSSCData_FuJ
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL1.GetMaxID("Issue", "FCSSCData_FuJ");
        }
        ...
        public bool Exists(int Issue)
        {
            ...
            strSql.Append("select count(1) from FCSSCData_FuJ");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.FCSSCData_FuJ model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into FCSSCData_FuJ(");
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(Pbzx.Model.FCSSCData_FuJ model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update FCSSCData_FuJ set ");
        ...
        public int Delete(int Issue)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from FCSSCData_FuJ ");
            strSql.Append(" where Issue=@Issue ");
            SqlParameter[] parameters = {
					new SqlParameter("@Issue", SqlDbType.Int,4)};
            parameters[0].Value = Issue;
        ...
        public Pbzx.Model.FCSSCData_FuJ GetModel(int Issue)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Issue,date,Code,LastModifytime,OpName,OpIp from FCSSCData_FuJ ");
            strSql.Append(" where Issue=@Issue ");
            SqlParameter[] parameters = {
					new SqlParameter("@Issue", SqlDbType.Int,4)};
            parameters[0].Value = Issue;

            Pbzx.Model.FCSSCData_FuJ model = new Pbzx.Model.FCSSCData_FuJ();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM FCSSCData_FuJ ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "FCSSCData_FuJ";
