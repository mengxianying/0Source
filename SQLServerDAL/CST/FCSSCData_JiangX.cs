...
{
    /// <summary>
    /// 数据访问类FCSSCData_JiangX。
    /// </summary>
    public class FCSSCData_JiangX : IFCSSCData_JiangX
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL1.GetMaxID("Issue", "FCSSCData_JiangX");
        }
        ...
        public bool Exists(int Issue)
        {
            ...
            strSql.Append("select count(1) from FCSSCData_JiangX");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.FCSSCData_JiangX model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into FCSSCData_JiangX(");
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(Pbzx.Model.FCSSCData_JiangX model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update FCSSCData_JiangX set ");
        ...
        public int Delete(int Issue)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from FCSSCData_JiangX ");
            strSql.Append(" where Issue=@Issue ");
            SqlParameter[] parameters = {
					new SqlParameter("@Issue", SqlDbType.Int,4)};
            parameters[0].Value = Issue;
        ...
        public Pbzx.Model.FCSSCData_JiangX GetModel(int Issue)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Issue,date,Code,LastModifytime,OpName,OpIp from FCSSCData_JiangX ");
            strSql.Append(" where Issue=@Issue ");
            SqlParameter[] parameters = {
					new SqlParameter("@Issue", SqlDbType.Int,4)};
            parameters[0].Value = Issue;

            Pbzx.Model.FCSSCData_JiangX model = new Pbzx.Model.FCSSCData_JiangX();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM FCSSCData_JiangX ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "FCSSCData_JiangX";
