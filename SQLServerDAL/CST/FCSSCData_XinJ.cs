...
namespace Pbzx.SQLServerDAL
{
    ...
    /// 数据访问类FCSSCData_XinJ。
    /// </summary>
    public class FCSSCData_XinJ : IFCSSCData_XinJ
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL1.GetMaxID("Issue", "FCSSCData_XinJ");
        }
        ...
        public bool Exists(int Issue)
        {
            ...
            strSql.Append("select count(1) from FCSSCData_XinJ");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.FCSSCData_XinJ model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into FCSSCData_XinJ(");
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(Pbzx.Model.FCSSCData_XinJ model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update FCSSCData_XinJ set ");
        ...
        public int Delete(int Issue)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from FCSSCData_XinJ ");
            strSql.Append(" where Issue=@Issue ");
            SqlParameter[] parameters = {
					new SqlParameter("@Issue", SqlDbType.Int,4)};
            parameters[0].Value = Issue;
        ...
        public Pbzx.Model.FCSSCData_XinJ GetModel(int Issue)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Issue,date,Code,LastModifytime,OpName,OpIp from FCSSCData_XinJ ");
            strSql.Append(" where Issue=@Issue ");
            SqlParameter[] parameters = {
					new SqlParameter("@Issue", SqlDbType.Int,4)};
            parameters[0].Value = Issue;

            Pbzx.Model.FCSSCData_XinJ model = new Pbzx.Model.FCSSCData_XinJ();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM FCSSCData_XinJ ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "FCSSCData_XinJ";
