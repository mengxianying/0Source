...
{
    public class TC31X7Data : ITC31X7Data
    {
        #region  成员方法
        ...
        public int GetMaxId()
        {
            return DbHelperSQL1.GetMaxID("issue", "TC31X7Data");
        }
        ...
        public bool Exists(int issue)
        {
            ...
            strSql.Append("select count(1) from TC31X7Data");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.TC31X7Data model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TC31X7Data(");
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(Pbzx.Model.TC31X7Data model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TC31X7Data set ");
        ...
        public int Delete(int issue)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TC31X7Data ");
            strSql.Append(" where issue=@issue ");
            SqlParameter[] parameters = {
					new SqlParameter("@issue", SqlDbType.Int,4)};
            parameters[0].Value = issue;
        ...
        public Pbzx.Model.TC31X7Data GetModel(int issue)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 date,issue,code,tcode,LastModifytime,OpName,OpIp from TC31X7Data ");
            strSql.Append(" where issue=@issue ");
            SqlParameter[] parameters = {
					new SqlParameter("@issue", SqlDbType.Int,4)};
            parameters[0].Value = issue;

            Pbzx.Model.TC31X7Data model = new Pbzx.Model.TC31X7Data();
