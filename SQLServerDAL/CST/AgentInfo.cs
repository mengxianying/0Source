...
namespace Pbzx.SQLServerDAL
{
    ...
    public class AgentInfo : IAgentInfo
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL1.GetMaxID("ID", "AgentInfo");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from AgentInfo");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.AgentInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into AgentInfo(");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@agtmore", SqlDbType.NText),
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(Pbzx.Model.AgentInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update AgentInfo set ");
        ...
        public int Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from AgentInfo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public Pbzx.Model.AgentInfo GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Password,Name,Company,Telephone,Fax,Mobile,EMail,PostCode,Province,Address,CreateDate,ExpireDate,Type,PricePercent,Status,Remark,delshow,countid,agtmore,postmore,agttype,UserName from AgentInfo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;

            Pbzx.Model.AgentInfo model = new Pbzx.Model.AgentInfo();
