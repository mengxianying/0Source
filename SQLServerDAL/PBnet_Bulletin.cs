...
namespace Pbzx.SQLServerDAL
{
	...
	/// 数据访问类PBnet_Bulletin。
	/// </summary>
	public class PBnet_Bulletin:IPBnet_Bulletin 
	{
        ...
        public bool Exists(int IntID)
        {
            ...
            strSql.Append("select count(1) from PBnet_Bulletin");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.PBnet_Bulletin model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into PBnet_Bulletin(");
            strSql.Append("NvarTitle,NvarShortTitle,NteContent,NvarAuthor,DatDateAndTime,IntChannelID,IntShowType,BitIsPass,BitIsTop,IntDisPosition,IntClick,VarPicUrl,VarOperator,IntOrderID,BitIsHot,NKey,Metadesc,Source,SourceUrl,Attribute,RandomFileName,EffectDate,Templet,SavePath,FileEXName,IsStatic,PageNum,ShowIndex,ShowInSoft,InWeiXin)");
            ...
            parameters[9].Value = model.IntDisPosition;
            parameters[10].Value = model.IntClick;
            parameters[11].Value = model.VarPicUrl;
            parameters[12].Value = model.VarOperator;
            parameters[13].Value = model.IntOrderID;
            parameters[14].Value = model.BitIsHot;
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(Pbzx.Model.PBnet_Bulletin model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update PBnet_Bulletin set ");
            ...
            parameters[8].Value = model.BitIsPass;
            parameters[9].Value = model.BitIsTop;
            ...
            parameters[15].Value = model.BitIsHot;
        ...
        public int Delete(int IntID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from PBnet_Bulletin ");
            strSql.Append(" where IntID=@IntID ");
            SqlParameter[] parameters = {
					new SqlParameter("@IntID", SqlDbType.Int,4)};
            parameters[0].Value = IntID;
        ...
        public Pbzx.Model.PBnet_Bulletin GetModel(int IntID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 IntID,NvarTitle,NvarShortTitle,NteContent,NvarAuthor,DatDateAndTime,IntChannelID,IntShowType,BitIsPass,BitIsTop,IntDisPosition,IntClick,VarPicUrl,VarOperator,IntOrderID,BitIsHot,NKey,Metadesc,Source,SourceUrl,Attribute,RandomFileName,EffectDate,Templet,SavePath,FileEXName,IsStatic,PageNum,ShowIndex,ShowInSoft,InWeiXin from PBnet_Bulletin ");
            strSql.Append(" where IntID=@IntID ");
            SqlParameter[] parameters = {
					new SqlParameter("@IntID", SqlDbType.Int,4)};
            parameters[0].Value = IntID;

            Pbzx.Model.PBnet_Bulletin model = new Pbzx.Model.PBnet_Bulletin();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    if ((ds.Tables[0].Rows[0]["BitIsTop"].ToString() == "1") || (ds.Tables[0].Rows[0]["BitIsTop"].ToString().ToLower() == "true"))
                    {
                        model.BitIsTop = true;
                    }
                    else
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "PBnet_Bulletin";
