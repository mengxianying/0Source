        ...
        public string InsertOrders(Pbzx.Model.PBnet_Orders orders, DataSet shoppingCartList)
        {
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.ConnectionString))
            {
                ...
                try
                {
                    ...
                    #region 初始化订单状态
                    //int[] staticIDList ={(int)Pbzx.Model.PBnet_OrderStatic.是否已确认, (int)Pbzx.Model.PBnet_OrderStatic.是否已付款, (int)Pbzx.Model.PBnet_OrderStatic.是否已发货, (int)Pbzx.Model.PBnet_OrderStatic.是否已完成, };
