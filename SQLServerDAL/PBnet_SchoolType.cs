...
{
    /// <summary>
    /// 数据访问类PBnet_SchoolType。
    /// </summary>
    public class PBnet_SchoolType : IPBnet_SchoolType
    {
        ...
        public bool Exists(int IntNewsTypeID)
        {
            ...
            strSql.Append("select count(1) from PBnet_SchoolType");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.PBnet_SchoolType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into PBnet_SchoolType(");
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(Pbzx.Model.PBnet_SchoolType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update PBnet_SchoolType set ");
        ...
        public int Delete(int IntNewsTypeID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from PBnet_SchoolType ");
            strSql.Append(" where IntNewsTypeID=@IntNewsTypeID ");
            SqlParameter[] parameters = {
					new SqlParameter("@IntNewsTypeID", SqlDbType.Int,4)};
            parameters[0].Value = IntNewsTypeID;
        ...
        public Pbzx.Model.PBnet_SchoolType GetModel(int IntNewsTypeID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 IntNewsTypeID,VarTypeName,IntTypeFID,IntTypeLevel,BitComment,BitIsAuditing,IntOrderID,Depth,RootID,ModuleFIDS,TypeEnName,DisCount,IntSortID from PBnet_SchoolType ");
            strSql.Append(" where IntNewsTypeID=@IntNewsTypeID ");
            SqlParameter[] parameters = {
					new SqlParameter("@IntNewsTypeID", SqlDbType.Int,4)};
            parameters[0].Value = IntNewsTypeID;

            Pbzx.Model.PBnet_SchoolType model = new Pbzx.Model.PBnet_SchoolType();
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "PBnet_SchoolType";
