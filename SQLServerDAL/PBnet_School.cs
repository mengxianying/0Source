...
namespace Pbzx.SQLServerDAL
{
    ...
    /// 数据访问类PBnet_School。
    /// </summary>
    public class PBnet_School : IPBnet_School
    {
        public PBnet_School()
        { }
        #region  成员方法
        ...
        public bool Exists(int IntID)
        {
            ...
            strSql.Append("select count(1) from PBnet_School");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Pbzx.Model.PBnet_School model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into PBnet_School(");
            strSql.Append("NvarTitle,NvarShortTitle,NteContent,NvarAuthor,DatDateAndTime,IntChannelID,IntShowType,BitIsPass,BitIsTop,BitIsHot,IntDisPosition,IntClick,VarPicUrl,VarOperator,IntOrderID,NKey,Metadesc,Source,SourceUrl,Attribute,RandomFileName,EffectDate,Templet,SavePath,FileEXName,IsStatic,PageNum,ShowIndex)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@IntDisPosition", SqlDbType.VarChar,500),
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(Pbzx.Model.PBnet_School model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update PBnet_School set ");
            ...
            parameters[10].Value = model.BitIsHot;
        ...
        public int  Delete(int IntID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from PBnet_School ");
            strSql.Append(" where IntID=@IntID ");
            SqlParameter[] parameters = {
					new SqlParameter("@IntID", SqlDbType.Int,4)};
            parameters[0].Value = IntID;
        ...
        public Pbzx.Model.PBnet_School GetModel(int IntID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 IntID,NvarTitle,NvarShortTitle,NteContent,NvarAuthor,DatDateAndTime,IntChannelID,IntShowType,BitIsPass,BitIsTop,BitIsHot,IntDisPosition,IntClick,VarPicUrl,VarOperator,IntOrderID,NKey,Metadesc,Source,SourceUrl,Attribute,RandomFileName,EffectDate,Templet,SavePath,FileEXName,IsStatic,PageNum,ShowIndex from PBnet_School ");
            strSql.Append(" where IntID=@IntID ");
            SqlParameter[] parameters = {
					new SqlParameter("@IntID", SqlDbType.Int,4)};
            parameters[0].Value = IntID;

            Pbzx.Model.PBnet_School model = new Pbzx.Model.PBnet_School();
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "PBnet_School";
