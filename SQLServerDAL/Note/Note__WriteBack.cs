...
namespace Pbzx.SQLServerDAL.Note
{
    /// <summary>
    /// 短信回复类
    /// </summary>
    public class Note__WriteBack : INote__WriteBack
    {

        public bool Exists(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Note__WriteBack");
        ...
        public void Add(Model.Note__WriteBack model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Note__WriteBack(");
        ...
        public void Update(Model.Note__WriteBack model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Note__WriteBack set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete Note__WriteBack ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
				};
        ...
        public Model.Note__WriteBack GetModel(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from Note__WriteBack ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
            Pbzx.Model.Note__WriteBack model = new Pbzx.Model.Note__WriteBack();
