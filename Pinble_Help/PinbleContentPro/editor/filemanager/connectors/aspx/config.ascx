...
<script runat="server">
	...
	private bool CheckAuthentication()
	{
        ...
        if (Pbzx.Web.WebFunc.CheckAdminUpload())
        {
            return true;
        }
        else
	...
	public override void SetConfig()
	{
        ...
        AllowedTypes = new string[] {"Image" };//"File", , "Flash", "Media"
...
//		HtmlExtensions = new string[] { "html", "htm", "xml", "xsd", "txt", "js" };
        ...
        TypeConfig["Image"].AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png", "swf", "flv" };
