...
{
    /// <summary>
    /// 业务逻辑类CN_Online 的摘要说明。
    /// </summary>
    public class CN_Online
    {
       
        private readonly ICN_Online dal = DataAccess.CreateCN_Online();
        Pbzx.SQLServerDAL.Basic basicDAL = new Pbzx.SQLServerDAL.Basic("CN_Online", "ID");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(Pbzx.Model.CN_Online model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Pbzx.Model.CN_Online model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Pbzx.Model.CN_Online GetModel(int ID)
        {
        ...
        /// 得到一个对象实体，从缓存中。
        /// </summary>
        public Pbzx.Model.CN_Online GetModelByCache(int ID)
        {

            string CacheKey = "CN_OnlineModel-" + ID;
            ...
            return (Pbzx.Model.CN_Online)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Pbzx.Model.CN_Online> GetModelList(string strWhere)
        {
            DataSet ds = dal.GetList(strWhere);
            List<Pbzx.Model.CN_Online> modelList = new List<Pbzx.Model.CN_Online>();
            int rowsCount = ds.Tables[0].Rows.Count;
            if (rowsCount > 0)
            {
                Pbzx.Model.CN_Online model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Pbzx.Model.CN_Online();
        ...
        {
            return basicDAL.GuestGetBySearch(basicDAL.strPKName, "CN_Online", SearchStr, getFileds, OrderStr, PageNum, orderType, CurrentPage, out Counts);
        }
    }
}
