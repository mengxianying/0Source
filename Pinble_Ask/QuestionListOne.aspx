<%@ Page Language="C#" AutoEventWireup="true" Codebehind="QuestionListOne.aspx.cs"
    Inherits="Pinble_Ask.QuestionListOne" %>
        ...
        <div>
            ...
            <div class="main">
                <div align="left">
                    <div class="Link_Xia">
                        <a href="/">拼搏吧</a> >> <a href="#">
                            <asp:Label ID="lblLink" runat="server" Text=""></asp:Label></a>
                    </div>
                </div>
            </div>
            <div class="main">
                <div class="Listl">
                    ...
                    <div class="class_content3">
                        <asp:GridView ID="MyGridView" runat="server" AutoGenerateColumns="False" Width="95%"
                            HorizontalAlign="Center" BorderWidth="0px" GridLines="Horizontal">
                            <Columns>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <a href='Question.aspx?question=<%# Input.Encrypt(Eval("Id").ToString()) %>' target="_blank"
                                            class="Linl14" title='<%#Eval("Title") %>'>
                                                         <%# Convert.ToBoolean(Eval("IsCommend")) ? "<font color='red'>[精]</font>" : "" %> <%#StrFormat.CutStringByNum(Eval("Title"),21*2)%>
                                        </a>[<span class="f14gray"><a href='QuestionList.aspx?type=<%# Input.Encrypt(Eval("TypeID").ToString()) %>'
                                            target="_blank"><%#Eval("TypeName") %></a></span>]
                                    </ItemTemplate>
                                    <ItemStyle Width="62%" Height="22px" />
                                ...
                                <asp:TemplateField HeaderText="状态">
                                    ...
                                    <ItemStyle Width="9%" HorizontalAlign="Center" Font-Bold="True" />
                                    <ControlStyle CssClass="list_xia2" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                            ...
                            <RowStyle BorderStyle="None" BorderColor="#F3F3F3" />
                        </asp:GridView>
