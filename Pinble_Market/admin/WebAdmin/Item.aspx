<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Item.aspx.cs" Inherits="Pinble_Market.admin.WebAdmin.Item" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="myGridView" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" CellPadding="3" BackColor="#97BEE7" CellSpacing="1" GridLines="None" Width="99%" AllowPaging="True" OnRowCreated="myGridView_RowCreated"
                ...
                OnRowEditing="myGridView_RowEditing" OnRowUpdating="myGridView_RowUpdating" OnRowDeleting="myGridView_RowDeleting">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="发布人">
                        <ItemTemplate>
                            <a href='UserItem.aspx?Name=<%# Pbzx.Common.Input.Encrypt(Eval("UserID").ToString()) %>'>
                                <%# Eval("UserID") %>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
